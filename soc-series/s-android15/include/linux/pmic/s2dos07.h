...
struct s2dos07_dev {
	...
	struct s2dos07_irq_data irq_data;
...
extern int s2dos07_create_irq_notifier_wq(struct device *dev, struct s2dos07_dev *s2dos07);
extern int s2dos07_register_irq_notifier(struct notifier_block *nb);

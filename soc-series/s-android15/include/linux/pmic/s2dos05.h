...
struct s2dos05_dev {
	...
	char irq_name[32];
	struct s2dos05_irq_data irq_data;
...
extern int s2dos05_create_irq_notifier_wq(struct device *dev, struct s2dos05_dev *s2dos05);
extern int s2dos05_register_irq_notifier(struct notifier_block *nb);

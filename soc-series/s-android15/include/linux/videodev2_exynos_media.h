...
/* P010(V4L2_PIX_FMT_NV12N_P010) single-fd without extra buffer */
#define NV12N_P010_STRIDE(w)		(__ALIGN_UP((w * 2), 128))
#define NV12N_P010_Y_SIZE(w, h)		(NV12N_P010_STRIDE(w) * __ALIGN_UP((h), 16))
#define NV12N_P010_CBCR_SIZE(w, h)	(NV12N_P010_STRIDE(w) * __ALIGN_UP((h), 16) / 2)

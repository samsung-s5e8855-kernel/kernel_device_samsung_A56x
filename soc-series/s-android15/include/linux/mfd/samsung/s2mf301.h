/*
 * s2mf301.h - Header of S2MF301 MFD Driver
 *
...
#ifndef __S2MF301_H__
#define __S2MF301_H__
...
#define S2MF301_REG_TOP_RIDINT		0x01
#define S2MF301_REG_FLEDINT     0x02
#define S2MF301_REG_IPINT_MASK	0x08
#define S2MF301_REG_PMICID		0xF4
...
enum s2mf301_irq_source {
	...
	FG_INT,
#endif
#if IS_ENABLED(CONFIG_S2MF301X) && (IS_ENABLED(CONFIG_LEDS_S2MF301_FLASH) || IS_ENABLED(CONFIG_TOP_S2MF301))
	FLED_INT,
#elif !IS_ENABLED(CONFIG_S2MF301X) && IS_ENABLED(CONFIG_LEDS_S2MF301_FLASH)
	FLED_INT,
#endif
...
#else
#define S2MF301_NUM_IRQ_CHG_REGS	7
#endif
...
#else
#define S2MF301_IRQSRC_CC_RID	(1 << 7)
#define S2MF301_IRQSRC_PM_RID	(1 << 7)
#endif
...
enum s2mf301_irq {
...
#else
	S2MF301_TOP_CC_RID_IRQ_RID_MASK_ALL,
#endif
#endif
#if IS_ENABLED(CONFIG_FUELGAUGE_S2MF301)
...
#if !IS_ENABLED(CONFIG_S2MF301X)
	S2MF301_PM_ADC_CHANGE_INT4_PMOFF,
#endif
#endif
#if IS_ENABLED(CONFIG_REGULATOR_S2MF301)
	...
	S2MF301_CHG0_IRQ_VBUS_DET,
	S2MF301_CHG0_IRQ_BATID,
	S2MF301_CHG0_IRQ_BUCK_CHG_MODE,
	S2MF301_CHG0_IRQ_BUCK_ONLY_MODE,
	S2MF301_CHG0_IRQ_CHGIN_SS_END,
	...
	S2MF301_CHG2_IRQ_VOLTAGE_LOOP,
	S2MF301_CHG2_IRQ_SC_CC_LOOP,
	S2MF301_CHG2_IRQ_BST_START_END,
	S2MF301_CHG2_IRQ_OTG_SS_END,
	S2MF301_CHG2_IRQ_OTG_LBAT,
	S2MF301_CHG2_IRQ_OTG_OCP_IN2BAT,

	S2MF301_CHG3_IRQ_TOPOFF_TIMER_FAULT,
	S2MF301_CHG3_IRQ_LC_SC_CV_CHG_TIMER_FAULT,
	S2MF301_CHG3_IRQ_PRE_TRICKLE_CHG_TIMER_FAULT,
	S2MF301_CHG3_IRQ_BAT_OCP,
	S2MF301_CHG3_IRQ_INPUT_OCP,
	S2MF301_CHG3_IRQ_WDT_TIMER_FAULT,
	S2MF301_CHG3_IRQ_VSYS_OVP,
	S2MF301_CHG3_IRQ_VSYS_SCP,
	...
	S2MF301_CHG4_IRQ_TFB,
	S2MF301_CHG4_IRQ_TSD,
	S2MF301_CHG4_IRQ_VSYS_SCP_TIMER_FAULT,
	S2MF301_CHG4_IRQ_PVDD_SHORT,
	S2MF301_CHG4_IRQ_CHGIN_LDO_DOWN,
	S2MF301_CHG4_IRQ_OTG_OCP,
	S2MF301_CHG4_IRQ_OTG_SCP,

	S2MF301_CHG5_IRQ_BYP_ON,
	S2MF301_CHG5_IRQ_SHIP_OR_OFF,
	S2MF301_CHG5_IRQ_BYP_SCP,
	S2MF301_CHG5_IRQ_BYP_ON_FALL,
	S2MF301_CHG5_IRQ_HS_ON,
	S2MF301_CHG5_IRQ_FWD_BYP_VIN_DROP,
	S2MF301_CHG5_IRQ_FWD_BYP_IN2BAT_OK,
	S2MF301_CHG5_IRQ_FWD_BYP_OCP,

	S2MF301_CHG6_IRQ_JEITA_0_LOW,
	S2MF301_CHG6_IRQ_JEITA_10_10,
	S2MF301_CHG6_IRQ_JEITA_20_10,
	S2MF301_CHG6_IRQ_JEITA_45_20,
	S2MF301_CHG6_IRQ_JEITA_60_45,
	S2MF301_CHG6_IRQ_JEITA_60_HIGH,
	S2MF301_CHG6_IRQ_CHG_TIMER_FAULT,
	S2MF301_CHG6_IRQ_REG_MODE_MISMATCH,
#endif
#endif
	S2MF301_IRQ_NR,
};

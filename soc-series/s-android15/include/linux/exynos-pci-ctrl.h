...
#if IS_ENABLED(CONFIG_PCI_EXYNOS_HOST)
...
extern void exynos_pcie_rc_check_payload(int ch_num);
#else
static int exynos_pcie_rc_poweron(int ch_num) { return 0; }
static void exynos_pcie_rc_poweroff(int ch_num) { return; }
...
static void exynos_pcie_rc_check_payload(int ch_num) { return; }
#endif

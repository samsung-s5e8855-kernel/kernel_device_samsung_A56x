...
#define HW_FORMAT_EMBEDDED_8BIT_POTF POTF_EN(HW_FORMAT_EMBEDDED_8BIT)
...
/* HW MCB MODE */
#define MCB_MODE_TETRA	  0
#define MCB_MODE_NONA	  1
#define MCB_MODE_HEXADECA 2
#define MCB_MODE_BYPASS	  3

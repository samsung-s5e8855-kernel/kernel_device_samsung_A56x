...
#define DPP_ATTR_RCD		(1 << 21)
#define DPP_ATTR_AFBC		(1 << 22)
...
/*
 * Attention: Keep the COMP_SUPPORT_* bit definitions in sync with
 *
 */
#define COMP_NOT_SUPPORTED	0
#define COMP_RGB_FLIP_H		(1 << 0)
#define COMP_RGB_FLIP_V		(1 << 1)
#define COMP_RGB_FLIP_ALL	(COMP_RGB_FLIP_H|COMP_RGB_FLIP_V)
#define COMP_RGB_ROT		(1 << 2)
#define COMP_RGB_ROT_FLIP	(1 << 3)
#define COMP_RGB_ALL		(COMP_RGB_ROT_FLIP|COMP_RGB_ROT|COMP_RGB_FLIP_ALL)
#define COMP_YUV420_FLIP_H	(1 << 4)
#define COMP_YUV420_FLIP_V	(1 << 5)
#define COMP_YUV420_FLIP_ALL	(COMP_YUV420_FLIP_H|COMP_YUV420_FLIP_V)
#define COMP_YUV420_ROT		(1 << 6)
#define COMP_YUV420_ROT_FLIP	(1 << 7)
#define COMP_YUV420_ALL		(COMP_YUV420_ROT_FLIP|COMP_YUV420_ROT|COMP_YUV420_FLIP_ALL)
#define COMP_YUV422_FLIP_H	(1 << 8)
#define COMP_YUV422_FLIP_V	(1 << 9)
#define COMP_YUV422_FLIP_ALL	(COMP_YUV422_FLIP_H|COMP_YUV422_FLIP_V)
#define COMP_YUV422_ROT		(1 << 10)
#define COMP_YUV422_ROT_FLIP	(1 << 11)
#define COMP_YUV422_ALL		(COMP_YUV422_ROT_FLIP|COMP_YUV422_ROT|COMP_YUV422_FLIP_ALL)

/*
 * Attention: Keep the DPHY_SLEEP_CTRL_* bit definitions in sync with
 * drivers/gpu/drm/samsung/dpu/exynos_drm_dsim.h enum dphy_pll_sleep_ctrl.
 */
#define DPHY_SLEEP_CTRL_UNSUPPORTED	(0)
#define DPHY_SLEEP_CTRL_LINK		(1)
#define DPHY_SLEEP_CTRL_DECON		(2)

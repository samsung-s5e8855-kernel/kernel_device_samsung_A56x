...
#ifndef _DT_BINDINGS_EXYNOS_9955_ESCA_IPC_H
#define _DT_BINDINGS_EXYNOS_9955_ESCA_IPC_H
...
#define ESCA_IPC_PHY__NOTI_DVFS			(ESCA_IPC_PHY__BASE + 6)
...
#define ESCA_IPC_APP__NOTI_BCM			(ESCA_IPC_APP__BASE + 8)
#define ESCA_IPC_APP__WOW			(ESCA_IPC_APP__BASE + 9)
#define ESCA_IPC_APP__MIF_GOV			(ESCA_IPC_APP__BASE + 10)
#define ESCA_IPC_APP__NPU_THERM			(ESCA_IPC_APP__BASE + 11)
#define ESCA_IPC_APP__MIF_GOV_NOTI		(ESCA_IPC_APP__BASE + 12)

#endif		/* _DT_BINDINGS_EXYNOS_9955_ESCA_IPC_H */

...
#define HVC_FID_GET_PROTECTED_KVM_ENABLED		(HVC_FID_BASE + 0x81)
#define HVC_FID_PKVM_UPDATE_HCR				(HVC_FID_BASE + 0x82)
#define HVC_FID_PKVM_UPDATE_FG_WRITE_TRAP		(HVC_FID_BASE + 0x83)
#define HVC_FID_PKVM_RECORD_EL2_INFO			(HVC_FID_BASE + 0x84)
#define HVC_FID_PKVM_SET_CPU_CONTEXT			(HVC_FID_BASE + 0x85)
...
#define HVC_FID_GET_PD_FROM_SUBSYSTEM			(HVC_FID_BASE + 0x10A)
...
#define HVC_FID_SET_S2MPU_WHITELIST			(HVC_FID_BASE + 0x113)
...
#define HVC_FID_SET_VM_BITMAP_BUF			(HVC_FID_BASE + 0x800)

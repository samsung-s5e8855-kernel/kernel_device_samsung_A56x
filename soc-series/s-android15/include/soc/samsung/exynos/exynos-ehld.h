...
extern int adv_tracer_ehld_set_enable(int en, bool log);
...
extern int adv_tracer_ehld_send_cmd(u32 ccmd, u32 val1, u32 val2, u32 ns_time, bool async);
extern int adv_tracer_ehld_clr_data(void);
#else
...
inline int adv_tracer_ehld_set_enable(int en, bool log) { return -1; }
...
inline int adv_tracer_ehld_send_cmd(u32 ccmd, u32 val1, u32 val2, u32 ns_time, bool async) { return 0; }
inline int adv_tracer_ehld_clr_data(void) { return -1; }
#endif

...
#define EXYNOS_PERF_INTERNAL_H __FILE__
...
extern int xperf_gpu_fn_init(const struct platform_device *pdev, const struct gpu_dvfs_fn* fn);
#endif /* EXYNOS_PERF_INTERNAL_H */

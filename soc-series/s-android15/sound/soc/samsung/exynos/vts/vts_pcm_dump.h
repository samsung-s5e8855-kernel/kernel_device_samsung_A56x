...
#define PCM_DUMP_NODE_REC      0
#define PCM_DUMP_NODE_TRI      1
#define PCM_DUMP_NODE_INTERNAL 2
#define PCM_DUMP_NODE_NS_L     3
#define PCM_DUMP_NODE_NS_R     4
...
/**
 * Request to start vts internal dump
 * @param[in]	dev		pointer to vts device
 * @param[in]	id		unique buffer id
 */
extern void vts_pcm_dump_check_n_set(struct device *dev, int id);

...
#ifndef __SND_SOC_VTS_DEP_SOC_V5_H
#define __SND_SOC_VTS_DEP_SOC_V5_H
...
#define VTS_BAAW_DRAM_DIV	   (0x1000)
...
#define VTSFW_VERSION_OFFSET	(0x191C00)
#define DETLIB_VERSION_OFFSET	(0xa8)

/* PMU Registers */
#define PAD_RETENTION_VTS_OPTION  (0x24E0) // VTS_OUT : PAD__RTO
...
#define VTS_IN_PMU_ADDR			(0x24d4)
#define VTS_PMU_SUB_V4_STATUS			(0x8)
#define VTS_PMU_SUB_V4_CPU_OUT			(0x40)
#define VTS_PMU_SUB_V4_CPU_OPTION		(0x2C)
...
static unsigned int vts_sfr_offset[] = {
    ...
    0x0210, 0x0214, 0x0220, 0x0224, 0x0230,
    0x0234, 0x0300, 0x0304, 0x0308, 0x030c,
    0x0310, 0x0314, 0x0318, 0x031c, 0x0320,
    0x0324, 0x0328, 0x032c, 0x0330, 0x0334,
    0x0338, 0x0344, 0x0348, 0x034c, 0x0350,
    ...
    0x0644, 0x0648, 0x0700, 0x0704, 0x0800,
    0x0804, 0x0808, 0x080c, 0x0810, 0x0814,
    0x0818, 0x081c, 0x0820, 0x0828, 0x0840,
    0x0900, 0x0920, 0x0924, 0x0928, 0x092c,
    0x0930, 0x0940, 0x0944, 0x0948, 0x1000,
    0x100c, 0x10a4, 0x1800, 0x2008, 0x2700,
    0x2704, 0x2708, 0x270c,
};
...
#define VTS_GPIO_BASE		   (0x14020000)
...
#endif
#endif /* __SND_SOC_VTS_DEP_SOC_V5_H */

...
int vts_clk_set_rate(struct device *dev, struct clk_path* path)
{
	...
	for (i = 0; (path[i].index >= 0) && (i < CLK_MAX_CNT); i++) {
		...
		vts_dev_info(dev,"%s: index:%d, value:%d %s: %d -> %lu, enabled: %d -> %d\n",
...
#elif defined(CONFIG_SOC_S5E9935) || defined(CONFIG_SOC_S5E8835) || defined(CONFIG_SOC_S5E9945) || defined(CONFIG_SOC_S5E8845) || defined(CONFIG_SOC_S5E9955) || defined(CONFIG_SOC_S5E8855)

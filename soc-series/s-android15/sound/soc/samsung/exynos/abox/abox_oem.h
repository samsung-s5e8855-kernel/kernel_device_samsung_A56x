...
enum ABOX_OEM_NOISE_TYPE {
	ABOX_OEM_CLK,
	ABOX_OEM_DMA_INTERVAL,
	ABOX_OEM_DMA_UNDERRUN,
};
...
extern void abox_oem_noise_detect(struct abox_data *data, enum ABOX_OEM_NOISE_TYPE type);

...
/**
 * get destination bit width of rdma
 * @param[in]	data	pointer to abox_data
 * @param[in]	dev_dma	pointer to dma device
 * @param[in]	id	id of the dma
 * @return		bit width or error code
 */
extern int abox_cmpnt_get_rdma_dst_bit_width(struct abox_data *data,
		struct device *dev_dma, int id);

/**
 * get destination bit width of wdma
 * @param[in]	data	pointer to abox_data
 * @param[in]	dev_dma	pointer to dma device
 * @param[in]	id	id of the dma
 * @return		bit width or error code
 */
extern int abox_cmpnt_get_wdma_dst_bit_width(struct abox_data *data,
		struct device *dev_dma, int id);
 ...
 * @param[in]	id		number
 * @param[in]	wname		widget name to add dapm route
 * @return	error code if any
 */
extern int abox_cmpnt_register_rdma(struct abox_data *data,
		struct device *dev, unsigned int id, const char *wname);
 ...
 * @return	error code if any
 */
extern int abox_cmpnt_register_wdma(struct abox_data *data,
		struct device *dev, unsigned int id, const char *wname);

...
#elif IS_ENABLED(CONFIG_SOC_S5E9955) || IS_ENABLED(CONFIG_SOC_S5E9945)
#define PCIE_IOMMU_CH_NUM 0
#endif
#endif
...
int abox_pci_register_driver(void)
{
	return platform_driver_register(&samsung_abox_pci_driver);
}

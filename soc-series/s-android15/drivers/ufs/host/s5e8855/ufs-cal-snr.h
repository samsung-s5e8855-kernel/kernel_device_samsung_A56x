...
static struct ufs_cal_save_and_restore_cfg hcs_dp_enable[] = {
	/* mib(just to monitor), sfr offset, sfr offset2 value, .. */
...
static struct ufs_cal_save_and_restore_cfg unipro_wa_enable[] = {
	...
	{UNIPRO,		0x7b00, 	0,	0x20, 		0, RESTORE_ONLY, READ_MASK_BIT, BRD_ALL, 0x20},	// delay time
...
static struct ufs_cal_save_and_restore_cfg save_pcs_sfr[] = {
	...
	{M_PHY_PCS_TRSV, 0x4008, 0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL,	0},
	{M_PHY_PCS_TRSV, 0x4034, 0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL,	0},
	{M_PHY_PCS_TRSV, 0x4048, 0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL,	0},
	...
	{M_PHY_PCS_TRSV, 0x8208, 0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL,	0},
	{M_PHY_PCS_TRSV, 0x8240, 0, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL,	0},
...
static struct ufs_cal_save_and_restore_cfg save_pma_sfr_evt0[] = {
	...
	//OTP
	{M_PHY_PMA_CMN, 0xC0E4, 0x0220, 0, 0, RESTORE_ONLY, PMA_AFC_OTP_CODE, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0xC0E5, 0x0224, 0, 0, RESTORE_ONLY, PMA_AFC_OTP_CODE, BRD_ALL, 0},
	...
	{M_PHY_PMA_CMN, 0x007c, 0x007c, 0x04, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0084, 0x0084, 0, 0, SAVE_AND_RESTORE, READ_WRITE_SFR, BRD_ALL, 0},

	{M_PHY_PMA_CMN, 0x0214, 0x0214, 0x0B, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
//	{M_PHY_PMA_CMN, 0x0220, 0x0220, 0x10, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},//set later
//	{M_PHY_PMA_CMN, 0x0224, 0x0224, 0x30, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},//set later
	{M_PHY_PMA_CMN, 0x0228, 0x0228, 0x10, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0230, 0x0230, 0xFF, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},

	{M_PHY_PMA_CMN, 0x0258, 0x0258, 0x35, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x025c, 0x025c, 0x35, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0260, 0x0260, 0x13, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0264, 0x0264, 0x13, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},

	{M_PHY_PMA_CMN, 0x027c, 0x027c, 0x20, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x02a8, 0x02a8, 0x0b, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},

	{M_PHY_PMA_CMN, 0x0354, 0x0354, 0x50, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	...
	{M_PHY_PMA_CMN, 0x02FC, 0x02FC, 0x10, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0300, 0x0300, 0x10, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x0308, 0x0308, 0x00, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0x030C, 0x030C, 0x10, 0, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	...
	{M_PHY_PMA_TRSV, 0x1050, 0x1050, 0x00, 0x00, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	...
	{M_PHY_PMA_TRSV, 0x17BC, 0x17BC, 0x17, 0x17, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},

	{M_PHY_PMA_TRSV, 0x17EC, 0x17EC, 0x16, 0x16, RESTORE_ONLY, WRITE_ONLY, BRD_ALL, 0},
	...
	{M_PHY_PMA_CMN, 0xC0E6, 0x0228, 0x00, 0, RESTORE_ONLY, PMA_AFC_OTP_CHECK, BRD_ALL, 0xF},
	{M_PHY_PMA_CMN, 0xC0E6, 0x022C, 0x11, 0, RESTORE_ONLY, PMA_AFC_OTP_CHECK, BRD_ALL, 0xF},
	{M_PHY_PMA_CMN, 0xC0E6, 0x0220, 0x10, 0, RESTORE_ONLY, PMA_AFC_OTP_CHECK, BRD_ALL, 0},
	{M_PHY_PMA_CMN, 0xC0E6, 0x0224, 0x30, 0, RESTORE_ONLY, PMA_AFC_OTP_CHECK, BRD_ALL, 0},

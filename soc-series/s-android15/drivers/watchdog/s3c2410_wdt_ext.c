...
static const struct s3c2410_wdt_variant drv_data_s5e5535_v1 = {
	.noncpu_int_en = S5E5535_CLUSTER0_NONCPU_INT_EN,
	.mask_bit = 2,
	.rst_stat_reg = S5E5535_RST_STAT_REG_OFFSET,
	.rst_stat_bit = 24,	/* CLUSTER0 WDTRESET */
	.pmu_reset_func = s3c2410wdt_noncpu_int_en,
	.quirks = QUIRK_HAS_PMU_CONFIG | QUIRK_HAS_RST_STAT | QUIRK_HAS_WTCLRINT_REG |
		  QUIRK_HAS_DBGACK_BIT | QUIRK_HAS_WTMINCNT_REG,
...
static const struct s3c2410_wdt_variant drv_data_s5e5535_v2 = {
	.noncpu_int_en = S5E5535_CLUSTER1_NONCPU_INT_EN,
	.mask_bit = 3,
	.rst_stat_reg = S5E5535_RST_STAT_REG_OFFSET,
	.rst_stat_bit = 25,	/* CLUSTER1 WDTRESET */
	.pmu_reset_func = s3c2410wdt_noncpu_int_en,
...
static const struct s3c2410_wdt_variant drv_data_s5e9955_v1 = {
	.noncpu_int_en = S5E9955_CLUSTER0_NONCPU_INT_EN,
	.mask_bit = 2,
	.rst_stat_reg = EXYNOS9955_RST_STAT_REG_OFFSET,
	.rst_stat_bit = 24,	/* CLUSTER0 WDTRESET */
	.pmu_reset_func = s3c2410wdt_noncpu_int_en,
	.quirks = QUIRK_HAS_PMU_CONFIG | QUIRK_HAS_RST_STAT | QUIRK_HAS_WTCLRINT_REG |
		  QUIRK_HAS_DBGACK_BIT | QUIRK_HAS_WTMINCNT_REG,
...
static const struct s3c2410_wdt_variant drv_data_s5e9955_v2 = {
	.noncpu_int_en = S5E9955_CLUSTER3_NONCPU_INT_EN,
	.mask_bit = 3,
	.rst_stat_reg = EXYNOS9955_RST_STAT_REG_OFFSET,
	.rst_stat_bit = 25,	/* CLUSTER3 WDTRESET */
	.pmu_reset_func = s3c2410wdt_noncpu_int_en,
	.quirks = QUIRK_HAS_PMU_CONFIG | QUIRK_HAS_RST_STAT | QUIRK_HAS_WTCLRINT_REG |
		  QUIRK_HAS_DBGACK_BIT | QUIRK_HAS_WTMINCNT_REG,
};
static const struct s3c2410_wdt_variant drv_data_s5e8855_v1 = {
        .noncpu_int_en = S5E8855_CLUSTER0_NONCPU_INT_EN,
        .mask_bit = 2,
        .rst_stat_reg = EXYNOS8855_RST_STAT_REG_OFFSET,
        .rst_stat_bit = 24,     /* CLUSTER0 WDTRESET */
        .pmu_reset_func = s3c2410wdt_noncpu_int_en,
        .quirks = QUIRK_HAS_PMU_CONFIG | QUIRK_HAS_RST_STAT | QUIRK_HAS_WTCLRINT_REG |
                  QUIRK_HAS_DBGACK_BIT | QUIRK_HAS_WTMINCNT_REG,
...
static const struct s3c2410_wdt_variant drv_data_s5e8855_v2 = {
        .noncpu_int_en = S5E8855_CLUSTER2_NONCPU_INT_EN,
        .mask_bit = 2,
        .rst_stat_reg = EXYNOS8855_RST_STAT_REG_OFFSET,
        .rst_stat_bit = 25,     /* CLUSTER2 WDTRESET */
        .pmu_reset_func = s3c2410wdt_noncpu_int_en,
...
static const struct of_device_id s3c2410_wdt_match[] = {
	...
	{ .compatible = "samsung,s5e5535-v1-wdt",
	  .data = &drv_data_s5e5535_v1 },
	{ .compatible = "samsung,s5e5535-v2-wdt",
	  .data = &drv_data_s5e5535_v2 },
	{ .compatible = "samsung,s5e9955-v1-wdt",
	  .data = &drv_data_s5e9955_v1 },
	{ .compatible = "samsung,s5e9955-v2-wdt",
	  .data = &drv_data_s5e9955_v2 },
	{ .compatible = "samsung,s5e8855-v1-wdt",
	  .data = &drv_data_s5e8855_v1 },
	{ .compatible = "samsung,s5e8855-v2-wdt",
	  .data = &drv_data_s5e8855_v2 },
	{},
};
				    ...
				    unsigned int timeout)
{
	...
	unsigned long wtcon, wtmincnt, wtcnt;
	...
	*/
	...
	if (count > S3C2410_WTCNT_MAXCNT) {
		divisor = DIV_ROUND_UP(count, S3C2410_WTCNT_MAXCNT);
	...
	if (wdt->drv_data->quirks & QUIRK_HAS_WTMINCNT_REG) {
		...
		/* Write count to WTCNT before WTMINCNT
		 * if current count is greater than WTMINCNT
		 * to avoid the watchdog reset as per the usermanual */
		wtcnt = readl(wdt->reg_base + S3C2410_WTCNT);
		if (wtcnt > wtmincnt)
			writel(wdt->count, wdt->reg_base + S3C2410_WTCNT);
		writel(wtmincnt, wdt->reg_base + EXYNOS_WTMINCNT);
...
static int s3c2410wdt_probe(struct platform_device *pdev)
{
	...
	ret = devm_request_irq(dev, irq, s3c2410wdt_irq, 0,
				pdev->name, pdev);
	if (ret != 0) {
...
#ifdef CONFIG_S3C2410_EXT_SHUTDOWN_REBOOT

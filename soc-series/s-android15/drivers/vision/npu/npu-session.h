...
#if NCP_VERSION >= 28
enum ncp_memory_type_plus {
	MEMORY_TYPE_NCP = MEMORY_TYPE_MAX,
	MEMORY_TYPE_NCP_HDR,
};
#endif
...
struct npu_session {
	...
	unsigned long weight_mem_buf_offset;
	...
	bool				kernel_loaded;
	u32 dl_unique_id;
	void *kernel_elf[MAX_USER_KERNEL];
	u32 kernel_elf_size[MAX_USER_KERNEL];

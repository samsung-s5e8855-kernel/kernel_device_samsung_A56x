 ...
 */
VISIBLE_IF_KUNIT int exynos_serial_has_interrupt_mask(struct uart_port *port)
{
	return to_ourport(port)->info->type == PORT_S3C6400;
}
EXPORT_SYMBOL_IF_KUNIT(exynos_serial_has_interrupt_mask);

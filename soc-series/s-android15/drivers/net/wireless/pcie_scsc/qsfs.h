...
enum slsi_qsf_sw_feature_id {
	...
	SLSI_QSF_SW_FEATURE_STANDARD_PLUS_ID
};
...
#define SLSI_QSF_SW_FEATURE_STANDARD_PLUS_LEN 7
...
//Standard NAN Feature Support
#define SLSI_GET_STD_NAN_MAJOR_NUMBER(nan_std_plus_versions)         (((nan_std_plus_versions) & 0x00FF))
#define SLSI_GET_STD_NAN_MINOR_NUMBER(nan_std_plus_versions)         (((nan_std_plus_versions) & 0xFF00) >> 8)

#define SLSI_QSF_ASC_SUPPORTED BIT(0)
#define SLSI_QSF_AMC_SUPPORTED BIT(1)
#define SLSI_QSF_AScC_SUPPORTED BIT(2)
#define SLSI_QSF_ADSDC_SUPPORTED BIT(3)
#define SLSI_QSF_STD_NAN_PAIRING_SUPPORTED BIT(4)
#define SLSI_QSF_AP_NAN_SUPPORTED BIT(5)
#define SLSI_QSF_CCM_SUPPORTED BIT(6)
#define SLSI_QSF_MDC_SUPPORTED BIT(7)

#define SLSI_QSF_PA_NAN_SUPPORTED BIT(0)
#define SLSI_QSF_FAST_CONNECT_CONTROL_SUPPORTED BIT(1)
#define SLSI_QSF_FAST_RECOVERY_SUPPORTED BIT(2)
#define SLSI_QSF_ANS_SUPPORTED BIT(3)
#define SLSI_QSF_NAN_EHT_MODE4_SUPPORTED BIT(4)
#define SLSI_QSF_NAN_EHT_MODE3_SUPPORTED BIT(5)
#define SLSI_QSF_NAN_EHT_MODE2_SUPPORTED BIT(6)
#define SLSI_QSF_NAN_EHT_MODE1_SUPPORTED BIT(7)

#define SLSI_QSF_ENHANCED_SDF_SUPPORTED BIT(0)
#define SLSI_QSF_FURTHER_ENHANCED_SDF_SUPPORTED BIT(1)
...
struct slsi_qsf_mib_data {
	...
	bool nan_std_plus_fast_recovery;
	u16 max_tdls_cli;
	u8 ht_caps[21];
	u8 vht_caps[12];
	u8 he_caps[32];
	u8 eht_caps[32];
	u8 misc_features_activated[21];
	u32 appendix_versions;
	u32 twt_control;
	u32 nan_std_plus_versions;
};

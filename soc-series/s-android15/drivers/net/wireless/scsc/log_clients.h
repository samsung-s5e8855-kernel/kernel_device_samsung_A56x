...
/* return True if a logging client has registered */
static inline bool slsi_log_clients_has_any_client(struct slsi_dev *sdev, struct slsi_log_clients *log_clients)
{
	return !list_empty(&log_clients->log_client_list);
}

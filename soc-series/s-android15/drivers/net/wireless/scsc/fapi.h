...
#define FAPI_TEST_SAP_ENG_VERSION                0x0019
...
#define FAPI_CWSTARTFLAGS_MEDIUM_POWER   0x0008
...
#define FAPI_EVENT_WIFI_EVENT_FW_MLD_T2LM_REQ_RESP                    0x005C
...
#define FAPI_EXTLNAMODE_AUTO                0
#define FAPI_EXTLNAMODE_OFF                 1
#define FAPI_EXTLNAMODE_SMART_SENSITIVITY   2
#define FAPI_EXTLNAMODE_MAX_SENSITIVITY     3
...
#define FAPI_RESULTCODE_REJECTED_BY_US                      0x8018
#define FAPI_RESULTCODE_REJECTED_BY_PEER                    0x8019
...
#define FAPI_RXREADFLAGS_NONE                   0x0000
#define FAPI_RXREADFLAGS_NON_ZERO_RATE_COUNTS   0x0001
#define FAPI_RXREADFLAGS_NON_ZERO_MISC_COUNTS   0x0002
#define FAPI_RXREADFLAGS_BATHTUB_RESET          0x0004
...
#define FAPI_RXSTARTFLAGS_RX_ALLOW_ALL_GOOD_FCS   0x8000
...
#define FAPI_TXDUPLICATE_DUP_NONE   0x0000
#define FAPI_TXDUPLICATE_DUP_40     0x0001
#define FAPI_TXDUPLICATE_DUP_80     0x0002
#define FAPI_TXDUPLICATE_DUP_160    0x0003
#define FAPI_TXDUPLICATE_DUP_320    0x0004
...
#define FAPI_TXSETPARAMSFLAGS2_RX_ALLOW_ALL_GOOD_FCS   0x8000
...
#define MLME_SET_NUM_TXRX_ANTENNAS_REQ        0x203f
...
#define MLME_GET_NUM_TXRX_ANTENNAS_REQ        0x204e
...
#define MLME_SET_KEEPALIVE_PARAMETERS_REQ     0x2078
#define MLME_SPARE_SIGNAL_1_REQ               0x2079
#define MLME_SPARE_SIGNAL_2_REQ               0x207a
#define MLME_SPARE_SIGNAL_3_REQ               0x207b
...
#define MLME_SET_NUM_TXRX_ANTENNAS_CFM        0x213f
...
#define MLME_GET_NUM_TXRX_ANTENNAS_CFM        0x214e
...
#define MLME_SET_KEEPALIVE_PARAMETERS_CFM     0x2178
#define MLME_SPARE_SIGNAL_1_CFM               0x2179
#define MLME_SPARE_SIGNAL_2_CFM               0x217a
#define MLME_SPARE_SIGNAL_3_CFM               0x217b
...
#define MLME_NAN_PAIRING_REQUEST_RES          0x220a
#define MLME_NAN_PAIRING_RESPONSE_RES         0x220b
#define MLME_SPARE_SIGNAL_1_RES               0x220c
#define MLME_SPARE_SIGNAL_2_RES               0x220d
#define MLME_SPARE_SIGNAL_3_RES               0x220e
...
struct fapi_signal {
	...
	union {
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_set_num_txrx_antennas_req;
		struct {
			__le16 vif;
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_get_num_txrx_antennas_req;
		struct {
			__le16 vif;
			__le32 spare_1;
			__le32 spare_2;
		...
		struct {
			__le16 vif;
			__le16 keepalive_time;
			__le16 spare_1;
			__le32 spare_2;
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_set_keepalive_parameters_req;
		struct {
			__le16 vif;
			__le32 spare_1;
			__le32 spare_2;
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_set_num_txrx_antennas_cfm;
		struct {
			__le16 vif;
			__le16 result_code;
			__le32 timestamp;
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_get_num_txrx_antennas_cfm;
		struct {
			__le16 vif;
			__le16 result_code;
			__le32 timestamp;
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_set_keepalive_parameters_cfm;
		struct {
			__le16 vif;
			__le16 result_code;
			__le32 spare_1;
		...
		struct {
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_nan_pairing_request_res;
		struct {
			__le16 vif;
			u8     peer_nmi_address[ETH_ALEN];
			__le16 session_id;
			...
			__le32 spare_3;
			u8     dr[0];
		} __packed mlme_nan_pairing_response_res;
		struct {
			__le16 vif;
			__le32 spare_1;
			__le32 spare_2;
...
static inline u16 fapi_get_expected_size(struct sk_buff *skb)
{
	...
	static const u16 fapi_mlme_req_size_table[] = {
		...
		fapi_sig_size(mlme_set_num_txrx_antennas_req),
		...
		fapi_sig_size(mlme_get_num_txrx_antennas_req),
		...
		fapi_sig_size(mlme_set_keepalive_parameters_req),
	...
	static const u16 fapi_mlme_cfm_size_table[] = {
		...
		fapi_sig_size(mlme_set_num_txrx_antennas_cfm),
		...
		fapi_sig_size(mlme_get_num_txrx_antennas_cfm),
		...
		fapi_sig_size(mlme_set_keepalive_parameters_cfm),
	...
	static const u16 fapi_mlme_res_size_table[] = {
		...
		fapi_sig_size(mlme_nan_pairing_request_res),
		fapi_sig_size(mlme_nan_pairing_response_res),
	...
	else if (fapi_is_test(skb) && fapi_is_res(skb))

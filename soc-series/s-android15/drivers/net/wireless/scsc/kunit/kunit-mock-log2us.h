...
#define slsi_conn_log2us_connect_sta_info(args...)		kunit_mock_slsi_conn_log2us_connect_sta_info(args)
...
static void kunit_mock_slsi_conn_log2us_connect_sta_info(struct slsi_dev *sdev, struct net_device *dev)
{
	return;
}

static void kunit_mock_slsi_conn_log2us_connecting(struct slsi_dev *sdev, struct net_device *dev,
...
static void kunit_mock_slsi_conn_log2us_dhcp_tx(struct slsi_dev *sdev, struct net_device *dev,
						char *str, char *tx_status, u8 mlo_band, char *dhcp_type_str)
{
	return;
}
...
static void kunit_mock_slsi_conn_log2us_dhcp(struct slsi_dev *sdev, struct net_device *dev, char *str, u8 mlo_band)
{
	return;
}
...
static void kunit_mock_slsi_conn_log2us_eapol_gtk_tx(struct slsi_dev *sdev, u32 status_code, u8 mlo_band)
{
	return;
}
...
static void kunit_mock_slsi_conn_log2us_assoc_req(struct slsi_dev *sdev, struct net_device *dev,
						  ...
						  int tx_status, int mgmt_frame_subtype, u8 mlo_band)
{
	return;
}
...
static void kunit_mock_slsi_conn_log2us_beacon_report_request(struct slsi_dev *sdev, struct net_device *dev,
							      ...
							      char *measure_mode, u8 request_mode, u8 mlo_band)
{
	return;
}

static void kunit_mock_slsi_conn_log2us_eapol_ptk_tx(struct slsi_dev *sdev, u32 status_code, u8 mlo_band)
{
	return;
}

static void kunit_mock_slsi_conn_log2us_eap(struct slsi_dev *sdev, struct net_device *dev,
					    u8 *eap_type, u8 mlo_band)
{
	return;
}

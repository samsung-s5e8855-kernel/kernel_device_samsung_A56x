...
#define slsi_rx_mlme_blockack_ind(args...)	kunit_mock_slsi_rx_mlme_blockack_ind(args)
#define slsi_rx_ba_update_timer(args...)	kunit_mock_slsi_rx_ba_update_timer(args)
...
static int kunit_mock_slsi_rx_ba_init(struct slsi_dev *sdev)
{
	return 0;
}
...
static void kunit_mock_slsi_rx_mlme_blockack_ind(struct slsi_dev *sdev, struct net_device *dev,
						 struct sk_buff *skb)
{
}

static void kunit_mock_slsi_rx_ba_update_timer(struct slsi_dev *sdev, struct net_device *dev,

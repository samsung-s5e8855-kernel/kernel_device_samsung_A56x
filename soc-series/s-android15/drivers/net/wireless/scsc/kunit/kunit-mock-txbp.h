...
#define slsi_txbp_service_open_post(args...)	kunit_mock_slsi_txbp_service_open_post(args)
...
static void kunit_mock_slsi_txbp_service_open_post(struct slsi_dev *sdev)
{
}
#endif

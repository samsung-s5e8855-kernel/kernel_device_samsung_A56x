...
#define scsc_service_register_link_change_notifier(args ...)	kunit_mock_scsc_service_register_link_change_notifier(args)
#define scsc_service_unregister_link_change_notifier(args ...)	kunit_mock_scsc_service_unregister_link_change_notifier(args)
...
#define scsc_service_pm_qos_update_cluster_request(args...)\
	kunit_mock_scsc_service_pm_qos_update_cluster_request(args)
...
#endif
#define scsc_log_collector_write(args...)			kunit_mock_scsc_log_collector_write(args)
#define scsc_log_collector_register_client(args...)		kunit_mock_scsc_log_collector_register_client(args)
#define scsc_log_collector_unregister_client(arg)		kunit_mock_scsc_log_collector_unregister_client(arg)


static struct mbulk *mb;
static struct firmware *firmware = NULL;
...
static int kunit_mock_mx140_request_file(struct scsc_mx *mx, char *path, struct firmware **firmp)
{
	...
	firmware = kzalloc(sizeof(*firmp), GFP_KERNEL);
...
static int kunit_mock_scsc_service_register_link_change_notifier(struct scsc_service *service, struct notifier_block *nb)
{
	if (service && !service->mx)
		return -EIO;
...
static int kunit_mock_scsc_service_unregister_link_change_notifier(struct scsc_service *service, struct notifier_block *nb)
{
	if (service && !service->mx)
		return -EIO;
...
static int kunit_mock_scsc_service_pm_qos_update_cluster_request(struct scsc_service *service,
...
static int kunit_mock_scsc_log_collector_write(char __user *buf, size_t count, u8 align)
{
	return 0;
}

static int kunit_mock_scsc_log_collector_register_client(struct scsc_log_collector_client *collect_client)
{
	return 0;
}

static int kunit_mock_scsc_log_collector_unregister_client(struct scsc_log_collector_client *collect_client)
{
	return 0;
}
#endif

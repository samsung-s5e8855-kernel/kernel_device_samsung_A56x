...
#define slsi_vendor_nan_set_command_event_ind(args...)	kunit_mock_slsi_vendor_nan_set_command_event_ind(args)
...
static void kunit_mock_slsi_vendor_nan_set_command_event_ind(struct slsi_dev *sdev, struct net_device *dev,
							     struct sk_buff *skb)
{
	if (skb) {
		kfree_skb(skb);

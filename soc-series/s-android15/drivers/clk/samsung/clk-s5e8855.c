...
#include "../../soc/samsung/exynos/cal-if/s5e8855/cmucal/cmucal-vclk.h"
#include "../../soc/samsung/exynos/cal-if/s5e8855/cmucal/cmucal-node.h"
#include "../../soc/samsung/exynos/cal-if/s5e8855/cmucal/cmucal-qch.h"
#include "../../soc/samsung/exynos/cal-if/s5e8855/cmucal/clkout_s5e8855.h"
#include "composite.h"

static struct samsung_clk_provider *s5e8855_clk_provider;
...
struct samsung_fixed_rate s5e8855_fixed_rate_ext_clks[] = {
	FRATE(OSCCLK1, "fin_pll1", NULL, 0, 76800000),
};

/* CMU_TOP */
struct init_vclk s5e8855_top_hwacg_vclks[] = {
...
struct init_vclk s5e8855_top_vclks[] = {
...
/* CMU ALIVE */
struct init_vclk s5e8855_alive_hwacg_vclks[] = {
...
struct init_vclk s5e8855_alive_vclks[] = {
	VCLK(DOUT_CLKALIVE_CHUBVTS_NOC, ALIVE_DIV_CLK_ALIVE_CHUBVTS_NOC, "DOUT_CLKALIVE_CHUBVTS_NOC", 0, 0, NULL),
	VCLK(DOUT_DIV_CLK_ALIVE_I2C, ALIVE_DIV_CLK_ALIVE_I2C, "DOUT_DIV_CLK_ALIVE_I2C", 0, 0, NULL),
	VCLK(DOUT_DIV_CLK_ALIVE_DBGCORE_UART, ALIVE_CLKDIV__DIV_CLK_ALIVE_DBGCORE_UART, "DOUT_DIV_CLK_ALIVE_DBGCORE_UART", 0, 0, NULL),
	...
	VCLK(DOUT_DIV_CLKALIVE_SCA_USI0, ALIVE_DIV_CLKALIVE_SCA_USI0, "DOUT_DIV_CLKALIVE_SCA_USI0", 0, 0, NULL),
	...
	VCLK(MOUT_MUX_CLK_ALIVE_USI0, ALIVE_MUX_CLK_ALIVE_USI0, "MOUT_MUX_CLK_ALIVE_USI0", 0, 0, NULL),
	VCLK(MOUT_MUX_CLK_ALIVE_I2C, ALIVE_MUX_CLK_ALIVE_I2C, "MOUT_MUX_CLK_ALIVE_I2C", 0, 0, NULL),


};

/* CMU_AUD */
struct init_vclk s5e8855_aud_hwacg_vclks[] = {
...
struct init_vclk s5e8855_aud_vclks[] = {
	...
	VCLK(DOUT_DIV_CLK_AUD_MCLK, AUD_DIV_CLK_AUD_MCLK, "DOUT_DIV_CLK_AUD_MCLK", 0, 0, NULL),
};

/* CMU_HSI */
struct init_vclk s5e8855_hsi_hwacg_vclks[] = {
...
struct init_vclk s5e8855_hsi_vclks[] = {
...
/* CMU_MFC */
struct init_vclk s5e8855_mfc_hwacg_vclks[] = {
...
struct init_vclk s5e8855_mfc_vclks[] = {
	...
	VCLK(UMUX_MUX_CLKCMU_MFC_NOC_USER, MFC_MUX_CLKCMU_MFC_NOC_USER, "UMUX_MUX_CLKCMU_MFC_NOC_USER", 0, 0, NULL),
};

/* CMU_MIF0 */
struct init_vclk s5e8855_mif0_hwacg_vclks[] = {
	HWACG_VCLK(MUX_MIF_DDRPHY2X, MIF0_CLKMUX_MIF_DDRPHY2X, "MUX_MIF_DDRPHY2X", NULL, 0, 0, NULL),
};

struct init_vclk s5e8855_mif0_vclks[] = {
};

/* CMU_MIF1 */
struct init_vclk s5e8855_mif1_hwacg_vclks[] = {
	HWACG_VCLK(MUX_MIF_DDRPHY2X_MIF1, MIF1_CLKMUX_MIF_DDRPHY2X, "MUX_MIF_DDRPHY2X_MIF1", NULL, 0, 0, NULL),
};

struct init_vclk s5e8855_mif1_vclks[] = {
};

/* CMU_NOCL0 */
struct init_vclk s5e8855_nocl0_hwacg_vclks[] = {
...
struct init_vclk s5e8855_nocl1a_vclks[] = {
	VCLK(DOUT_DIV_CLK_NOCL1A_NOCP, NOCL1A_DIV_CLK_NOCL1A_NOCP, "DOUT_DIV_CLK_NOCL1A_NOCP", 0, 0, NULL),
};

/* CMU_NOCL1B */

struct init_vclk s5e8855_nocl1b_hwacg_vclks[] = {
	HWACG_VCLK(GATE_CMU_NOCL1B_QCH, CMU_NOCL1B_QCH, "GATE_CMU_NOCL1B_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_D_TZPC_NOCL1B_QCH, D_TZPC_NOCL1B_QCH, "GATE_D_TZPC_NOCL1B_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_ECU_NOCL1B_QCH, ECU_NOCL1B_QCH, "GATE_ECU_NOCL1B_QCH", NULL, 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_TREX_PPMU_D0_NOCL1B_QCH, TREX_PPMU_D0_NOCL1B_QCH, "GATE_TREX_PPMU_D0_NOCL1B_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_TREX_PPMU_D1_NOCL1B_QCH, TREX_PPMU_D1_NOCL1B_QCH, "GATE_TREX_PPMU_D1_NOCL1B_QCH", NULL, 0, VCLK_GATE, NULL),
};

struct init_vclk s5e8855_nocl1b_vclks[] = {
	VCLK(DOUT_DIV_CLK_NOCL1B_NOCP, NOCL1B_DIV_CLK_NOCL1B_NOCP, "DOUT_DIV_CLK_NOCL1B_NOCP", 0, 0, NULL),
};

/* CMU_PERIC */
struct init_vclk s5e8855_peric_hwacg_vclks[] = {
...
struct init_vclk s5e8855_peric_vclks[] = {
	...
	VCLK(DOUT_DIV_CLK_PERIC_USI10_USI, PERIC_DIV_CLK_PERIC_USI10_USI_OIS, "DOUT_DIV_CLK_PERIC_USI10_USI", 0, 0, NULL),
...
/* CMU_RGBP */
struct init_vclk s5e8855_rgbp_hwacg_vclks[] = {
...
struct init_vclk s5e8855_rgbp_vclks[] = {
...
/* CMU_USB */
struct init_vclk s5e8855_usb_hwacg_vclks[] = {
...
struct init_vclk s5e8855_usb_vclks[] = {
...
/* CMU_YUVP */
struct init_vclk s5e8855_yuvp_hwacg_vclks[] = {
...
struct init_vclk s5e8855_yuvp_vclks[] = {
...
/* CMU_CSIS */
struct init_vclk s5e8855_csis_hwacg_vclks[] = {
...
struct init_vclk s5e8855_csis_vclks[] = {
...
struct init_vclk s5e8855_aoccsis_hwacg_vclks[] = {
...
/* CMU_CSTAT */
struct init_vclk s5e8855_cstat_hwacg_vclks[] = {
};

struct init_vclk s5e8855_cstat_vclks[] = {
...
/* CMU_M2M */
struct init_vclk s5e8855_m2m_hwacg_vclks[] = {
...
struct init_vclk s5e8855_m2m_vclks[] = {
...
struct init_vclk s5e8855_chub_hwacg_vclks[] = {
...
struct init_vclk s5e8855_chub_vclks[] = {
...
struct init_vclk s5e8855_chubvts_vclks[] = {
...
struct init_vclk s5e8855_cmgp_vclks[] = {
...
/* CMU_CPUCL0_GLB */
struct init_vclk s5e8855_cpucl0_glb_hwacg_vclks[] = {
};

struct init_vclk s5e8855_cpucl0_glb_vclks[] = {
	VCLK(MOUT_CLKCMU_CPUCL0_DBG_NOC_USER, CPUCL0_GLB_MUX_CLKCMU_CPUCL0_DBG_NOC_USER, "MOUT_CLKCMU_CPUCL0_DBG_NOC_USER", 0, 0, NULL),
};

/* CMU_ICPU */
struct init_vclk s5e8855_icpu_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_ICPU_QCH_CPU0, ICPU_TOP_QCH_CPU0, "GATE_ICPU_QCH_CPU0", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_ICPU_QCH_PERI, ICPU_TOP_QCH_PERI, "GATE_ICPU_QCH_PERI", NULL, 0, VCLK_GATE, NULL),
};

struct init_vclk s5e8855_icpu_vclks[] = {
...
/* CMU_GNPU0 */
struct init_vclk s5e8855_gnpu0_hwacg_vclks[] = {
...
struct init_vclk s5e8855_gnpu0_vclks[] = {
...
/* CMU_DPU */
struct init_vclk s5e8855_dpu_hwacg_vclks[] = {
...
struct init_vclk s5e8855_dpu_vclks[] = {
	...
	VCLK(DOUT_DIV_CLK_DPU_DSIM, DPU_DIV_CLK_DPU_DSIM, "DOUT_DIV_CLK_DPU_DSIM", 0, 0, NULL),
};

/* CMU_DSU */
struct init_vclk s5e8855_dsu_hwacg_vclks[] = {
...
struct init_vclk s5e8855_dsu_vclks[] = {
...
/* CMU_G3D */
struct init_vclk s5e8855_g3d_hwacg_vclks[] = {
...
struct init_vclk s5e8855_g3d_vclks[] = {
	...
	VCLK(DOUT_DIV_CLKCMU_G3D_HTU, TOP_DIV_CLKCMU_G3D_HTU, "DOUT_DIV_CLKCMU_G3D_HTU", 0, 0, NULL),
	VCLK(DOUT_DIV_CLKCMU_G3D_NOCP, TOP_DIV_CLKCMU_G3D_NOCP, "DOUT_DIV_CLKCMU_G3D_NOCP", 0, 0, NULL),
};

/* CMU_VTS */
struct init_vclk s5e8855_vts_hwacg_vclks[] = {
...
struct init_vclk s5e8855_vts_vclks[] = {
...
/* CMU_PSP */
struct init_vclk s5e8855_psp_hwacg_vclks[] = {
...
struct init_vclk s5e8855_psp_vclks[] = {
...
/* CMU_DNC */
struct init_vclk s5e8855_dnc_hwacg_vclks[] = {
...
struct init_vclk s5e8855_dnc_vclks[] = {
	VCLK(UMUX_CLKCMU_DNC_NOC, DNC_MUX_CLKCMU_DNC_NOC_USER, "UMUX_CLKCMU_DNC_NOC", 0, 0, NULL),
	VCLK(DOUT_DIV_CLK_DNC_NOCP, DNC_DIV_CLK_DNC_NOCP, "DOUT_DIV_CLK_DNC_NOCP", 0, 0, NULL),
};

/* CMU_SDMA */
struct init_vclk s5e8855_sdma_hwacg_vclks[] = {
...
struct init_vclk s5e8855_sdma_vclks[] = {
};

/* CMU_PERIS */
struct init_vclk s5e8855_peris_hwacg_vclks[] = {
...
struct init_vclk s5e8855_peris_vclks[] = {
	...
	VCLK(DOUT_DIV_CLK_PERIS_NOCP, PERIS_DIV_CLK_PERIS_NOCP, "DOUT_DIV_CLK_PERIS_NOCP", 0, 0, NULL),
	VCLK(OSC_PERIS_OSCCLK_SUB, PERIS_OSCCLK_SUB, "OSC_PERIS_OSCCLK_SUB", 0, 0, NULL),
};

/* CMU_USI */
struct init_vclk s5e8855_usi_hwacg_vclks[] = {
...
struct init_vclk s5e8855_sca_hwacg_vclks[] = {
	HWACG_VCLK(GATE_PMU_SCA_QCH, PMU_SCA_QCH, "GATE_PMU_SCA_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_CMU_SCA_QCH, CMU_SCA_QCH, "GATE_CMU_SCA_QCH", NULL, 0, VCLK_GATE, NULL),
};
struct init_vclk s5e8855_sca_vclks[] = {
	VCLK(DOUT_DIV_CLK_SCA_NOC_DIV2, SCA_DIV_CLK_SCA_NOC_DIV2, "DOUT_DIV_CLK_SCA_NOC_DIV2", 0, 0, NULL),
};
/* CLKOUT */
static struct init_vclk s5e8855_clkout_vclks[] = {
	VCLK(OSC_AUD, VCLK_CLKOUT0, "OSC_AUD", 0, 0, NULL),
};

static struct of_device_id ext_clk_match[] = {
	{.compatible = "samsung,s5e8855-oscclk", .data = (void *)0},
	{},
};

void s5e8855_vclk_init(void)
{
	/* Common clock init */
}

static int s5e8855_clock_probe(struct platform_device *pdev)
{
	...
	s5e8855_clk_provider = samsung_clk_init(np, reg_base, CLK_NR_CLKS);
	if (!s5e8855_clk_provider)
		panic("%s: unable to allocate context.\n", __func__);

	samsung_register_of_fixed_ext(s5e8855_clk_provider, s5e8855_fixed_rate_ext_clks,
					  ARRAY_SIZE(s5e8855_fixed_rate_ext_clks),
					  ext_clk_match);
	/* register HWACG vclk */
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_top_hwacg_vclks, ARRAY_SIZE(s5e8855_top_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_alive_hwacg_vclks, ARRAY_SIZE(s5e8855_alive_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_hsi_hwacg_vclks, ARRAY_SIZE(s5e8855_hsi_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_mif0_hwacg_vclks, ARRAY_SIZE(s5e8855_mif0_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_mif1_hwacg_vclks, ARRAY_SIZE(s5e8855_mif1_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_nocl0_hwacg_vclks, ARRAY_SIZE(s5e8855_nocl0_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_nocl1a_hwacg_vclks, ARRAY_SIZE(s5e8855_nocl1a_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_peric_hwacg_vclks, ARRAY_SIZE(s5e8855_peric_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_usb_hwacg_vclks, ARRAY_SIZE(s5e8855_usb_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_cmgp_hwacg_vclks, ARRAY_SIZE(s5e8855_cmgp_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_cpucl0_glb_hwacg_vclks, ARRAY_SIZE(s5e8855_cpucl0_glb_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_gnpu0_hwacg_vclks, ARRAY_SIZE(s5e8855_gnpu0_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_dpu_hwacg_vclks, ARRAY_SIZE(s5e8855_dpu_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_dsu_hwacg_vclks, ARRAY_SIZE(s5e8855_dsu_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_g3d_hwacg_vclks, ARRAY_SIZE(s5e8855_g3d_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_psp_hwacg_vclks, ARRAY_SIZE(s5e8855_psp_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_dnc_hwacg_vclks, ARRAY_SIZE(s5e8855_dnc_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_sdma_hwacg_vclks, ARRAY_SIZE(s5e8855_sdma_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_peris_hwacg_vclks, ARRAY_SIZE(s5e8855_peris_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_usi_hwacg_vclks, ARRAY_SIZE(s5e8855_usi_hwacg_vclks));

    /* register special vclk */
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_top_vclks, ARRAY_SIZE(s5e8855_top_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_alive_vclks, ARRAY_SIZE(s5e8855_alive_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_hsi_vclks, ARRAY_SIZE(s5e8855_hsi_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_nocl0_vclks, ARRAY_SIZE(s5e8855_nocl0_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_nocl1a_vclks, ARRAY_SIZE(s5e8855_nocl1a_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_peric_vclks, ARRAY_SIZE(s5e8855_peric_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_cmgp_vclks, ARRAY_SIZE(s5e8855_cmgp_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_cpucl0_glb_vclks, ARRAY_SIZE(s5e8855_cpucl0_glb_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_dsu_vclks, ARRAY_SIZE(s5e8855_dsu_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_clkout_vclks, ARRAY_SIZE(s5e8855_clkout_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_peris_vclks, ARRAY_SIZE(s5e8855_peris_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_usi_vclks, ARRAY_SIZE(s5e8855_usi_vclks));

	clk_exynos_skip_hw = true;

	samsung_register_vclk(s5e8855_clk_provider, s5e8855_aud_hwacg_vclks, ARRAY_SIZE(s5e8855_aud_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_mfc_hwacg_vclks, ARRAY_SIZE(s5e8855_mfc_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_rgbp_hwacg_vclks, ARRAY_SIZE(s5e8855_rgbp_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_yuvp_hwacg_vclks, ARRAY_SIZE(s5e8855_yuvp_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_csis_hwacg_vclks, ARRAY_SIZE(s5e8855_csis_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_cstat_hwacg_vclks, ARRAY_SIZE(s5e8855_cstat_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_m2m_hwacg_vclks, ARRAY_SIZE(s5e8855_m2m_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_chub_hwacg_vclks, ARRAY_SIZE(s5e8855_chub_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_icpu_hwacg_vclks, ARRAY_SIZE(s5e8855_icpu_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_vts_hwacg_vclks, ARRAY_SIZE(s5e8855_vts_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_aoccsis_hwacg_vclks, ARRAY_SIZE(s5e8855_aoccsis_hwacg_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_mcsc_hwacg_vclks, ARRAY_SIZE(s5e8855_mcsc_hwacg_vclks));

	samsung_register_vclk(s5e8855_clk_provider, s5e8855_g3d_vclks, ARRAY_SIZE(s5e8855_g3d_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_gnpu0_vclks, ARRAY_SIZE(s5e8855_gnpu0_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_vts_vclks, ARRAY_SIZE(s5e8855_vts_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_dpu_vclks, ARRAY_SIZE(s5e8855_dpu_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_usb_vclks, ARRAY_SIZE(s5e8855_usb_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_aud_vclks, ARRAY_SIZE(s5e8855_aud_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_mfc_vclks, ARRAY_SIZE(s5e8855_mfc_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_rgbp_vclks, ARRAY_SIZE(s5e8855_rgbp_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_yuvp_vclks, ARRAY_SIZE(s5e8855_yuvp_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_csis_vclks, ARRAY_SIZE(s5e8855_csis_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_cstat_vclks, ARRAY_SIZE(s5e8855_cstat_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_m2m_vclks, ARRAY_SIZE(s5e8855_m2m_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_sdma_vclks, ARRAY_SIZE(s5e8855_sdma_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_dnc_vclks, ARRAY_SIZE(s5e8855_dnc_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_psp_vclks, ARRAY_SIZE(s5e8855_psp_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_icpu_vclks, ARRAY_SIZE(s5e8855_icpu_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_chub_vclks, ARRAY_SIZE(s5e8855_chub_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_chubvts_vclks, ARRAY_SIZE(s5e8855_chubvts_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_dbgcore_vclks, ARRAY_SIZE(s5e8855_dbgcore_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_mif0_vclks, ARRAY_SIZE(s5e8855_mif0_vclks));
	samsung_register_vclk(s5e8855_clk_provider, s5e8855_mif1_vclks, ARRAY_SIZE(s5e8855_mif1_vclks));

	clk_exynos_skip_hw = false;

	clk_register_fixed_factor(NULL, "pwm-clock", "fin_pll", CLK_SET_RATE_PARENT, 1, 1);
	samsung_clk_of_add_provider(np, s5e8855_clk_provider);
	s5e8855_vclk_init();
	return 0;
}
...
static struct platform_driver s5e8855_clock_driver = {
	.driver = {
		.name = "s5e8855_clock",
		.of_match_table = of_exynos_clock_match,
	},
	.probe		= s5e8855_clock_probe,
	.id_table	= exynos_clock_ids,
};

static int s5e8855_clock_init(void)
{
	return platform_driver_register(&s5e8855_clock_driver);
}
arch_initcall(s5e8855_clock_init);

static void s5e8855_clock_exit(void)
{
	return platform_driver_unregister(&s5e8855_clock_driver);
}
module_exit(s5e8855_clock_exit);

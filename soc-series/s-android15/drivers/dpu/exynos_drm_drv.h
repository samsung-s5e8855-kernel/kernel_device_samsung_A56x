...
struct exynos_drm_properties {
	...
	struct drm_property *skip_hw_update;
	struct drm_property *skip_frameupdate;
	struct drm_property *partial;
	struct drm_property *dqe_fd;
	struct drm_property *color_fd_slot0;
	struct drm_property *color_fd_slot1;
	struct drm_property *bts_fps;
	struct drm_property *expected_present_time_ns;
	struct drm_property *frame_interval_ns;
	...
	struct drm_property *backlight_level;

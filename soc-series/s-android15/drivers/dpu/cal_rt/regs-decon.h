 ...
 * [ DPUB BASE ADDRESS ]
 *
 * - D_TZPC_DPUB             0x1901_0000
 * - SYSREG_DPUB             0x1902_0000 : DPU_MIPI_PHY_CON (0x1008)
 * - VMC_TOP		     0x1907_0000
 * - UPI_M0                  0x1908_0000
 * - MIPI_DSIM0              0x190B_0000
 * - MIPI_DSIM1              0x190C_0000
 * - MIPI_DSIM2              0x190D_0000
 * - MIPI_DCPHY              0x190E_0000
 * - DECON_MAIN              0x1910_0000
 * - DECON_WIN               0x1911_0000
 * - DECON_SUB               0x1912_0000
 * - DECON0_WINCON           0x1913_0000
 * - DECON1_WINCON           0x1914_0000
 * - DECON2_WINCON           0x1915_0000
 * - DECON3_WINCON           0x1916_0000
 * - DQE0                    0x1917_0000
 * - DQE1                    0x1918_0000
 *
 * [ DPUF0 BASE ADDRESS ]
 *
 * - CMU_DPUF0               0x1980_0000
 * - D_TZPC_DPU0             0x1981_0000
 * - SYSREG_DPU0             0x1982_0000 : DRCG (0x0104)
 * - SYSMMU_DPUF0D0_S1_NS    0x1984_0000
 * - SYSMMU_DPUF0D1_S1_NS    0x1985_0000
 * - SYSMMU_DPUF0D0_S1_S     0x1986_0000
 * - SYSMMU_DPUF0D1_S1_S     0x1987_0000
 * - SYSMMU_DPUF0D0_S2       0x1988_0000
 * - SYSMMU_DPUF0D1_S2       0x1989_0000
 * - PPMU_DPUF0D0            0x198A_0000
 * - PPMU_DPUF0D1            0x198B_0000
 * - DPUF0_DMA               0x1990_0000
 * - DPUF0_VGEN              0x1991_0000
 * - DPUF0_C2SERV            0x1992_0000
 * - DPUF0_DPP0              0x1993_0000
 * - DPUF0_DPP1              0x1994_0000
 * - DPUF0_SRAMC             0x1995_0000
 * - DPUF0_HDR_COMM          0x1996_0000
 * - DPP_HDR_LSI             0x1997_0000
 * - DPUF0_C2A               0x1999_0000
 *
 * [ DPUF1 BASE ADDRESS ]
 *
 * - CMU_DPUF0               0x19A0_0000
 * - D_TZPC_DPU0             0x19A1_0000
 * - SYSREG_DPU0             0x19A2_0000 : DRCG (0x0104)
 * - SYSMMU_DPUF0D0_S1_NS    0x19A4_0000
 * - SYSMMU_DPUF0D1_S1_NS    0x19A5_0000
 * - SYSMMU_DPUF0D0_S1_S     0x19A6_0000
 * - SYSMMU_DPUF0D1_S1_S     0x19A7_0000
 * - SYSMMU_DPUF0D0_S2       0x19A8_0000
 * - SYSMMU_DPUF0D1_S2       0x19A9_0000
 * - PPMU_DPUF0D0            0x19AA_0000
 * - PPMU_DPUF0D1            0x19AB_0000
 * - DPUF0_DMA               0x19B0_0000
 * - DPUF0_VGEN              0x19B1_0000
 * - DPUF0_C2SERV            0x19B2_0000
 * - DPUF0_DPP0              0x19B3_0000
 * - DPUF0_DPP1              0x19B4_0000
 * - DPUF0_SRAMC             0x19B5_0000
 * - DPUF0_HDR_COMM          0x19B6_0000
 * - DPP_HDR_LSI             0x19B7_0000
 * - DPUF0_C2A               0x19B9_0000
 *
 * [ HSI0 BASE ADDRESS ]
 *
 * - DP_LINK                 0x1788_0000
...
#define POST_SCALER_ON				SCALER_PATH_F(1)
...
//===[ G_XXX -- Global ]===
#define SRAMC_G_BASE_ADDR			(0x1995F000)
#define SRAMC_G1_BASE_ADDR			(0x19B5F000)

...
#include "../drivers/usb/dwc3/exynos-otg.h"
...
/* DP DSC */
	...
	u32 chunk_size;
	u32 slice_count;
	/* Picture Parameter Set 128 */
#define MAX_PPS_NUM	128
	u8 pps[MAX_PPS_NUM];
};
...
void dp_reg_set_hdr_infoframe(struct hdr_infoframe hdr_infofrmae, u32 en);
...
extern int dwc3_exynos_otg_inform_dp_use(int use, int lane_cnt);
extern int dwc3_exynos_phy_enable(int owner, bool on);
extern int dwc3_exynos_otg_is_usb_ready(void);

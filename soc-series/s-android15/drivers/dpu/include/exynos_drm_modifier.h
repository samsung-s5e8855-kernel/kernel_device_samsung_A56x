 ...
 * [18]		: SAJC swizzle mode indicator
 * [19]		: SAJC address mode indicator
 * [55:19]	: Reserved
 */
...
#define SAJC_2PKR				(0ULL)
#define SAJC_8PKR				(1ULL)
#define SAJC_MOD_ADDRESS_MODE_MASK		(0x1ULL << 19)
#define SAJC_MOD_ADDRESS_MODE_SET(addr_mode)	(((addr_mode) << 19) & SAJC_MOD_ADDRESS_MODE_MASK)
#define SAJC_MOD_ADDRESS_MODE_GET(mod)		(((mod) & SAJC_MOD_ADDRESS_MODE_MASK) >> 19)

#define DRM_FORMAT_MOD_SAMSUNG_SAJC(blk_size, sw_mode, addr_mode)	\
		fourcc_mod_code(SAMSUNG, (SAJC_IDENTIFIER |		\
			SAJC_BLK_SIZE_SET(blk_size) | SAJC_MOD_SW_MODE_SET(sw_mode) |	\
			SAJC_MOD_ADDRESS_MODE_SET(addr_mode)))

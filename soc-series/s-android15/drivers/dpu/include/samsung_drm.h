...
struct decon_restrict {
	...
	__u32 ppc;
	__u32 min_frame_interval_hz;
	__u32 vrr_timeout_ms;
	__u32 esyn_hz;
	bool  dvrr_en;
};
...
enum dpu_res_key {
	...
	DPU_RES_COMP_TRASFORM,

	DPU_RES_MIN_FRAME_INTERVAL_NS,
	DPU_RES_VRR_TIMEOUT_NS,
	DPU_RES_ESYN_PERIOD_NS,
};

 ...
 * [ DPUB BASE ADDRESS ]
 *
 * - D_TZPC_DPUB             0x1B01_0000
 * - SYSREG_DPUB             0x1B02_0000 : DPU_MIPI_PHY_CON (0x1008)
 * - VMC_TOP                 0x1B07_0000
 * - UPI_M0                  0x1B08_0000
 * - MIPI_DSIM0              0x1B0B_0000
 * - MIPI_DSIM1              0x1B0C_0000
 * - MIPI_DSIM2              0x1B0D_0000
 * - MIPI_DCPHY              0x1B0E_0000
 * - DECON_MAIN              0x1B10_0000
 * - DECON_WIN               0x1B11_0000
 * - DECON_SUB               0x1B12_0000
 * - DECON0_WINCON           0x1B13_0000
 * - DECON1_WINCON           0x1B14_0000
 * - DECON2_WINCON           0x1B15_0000
 * - DECON3_WINCON           0x1B16_0000
 * - DQE0                    0x1B17_0000
 * - DQE1                    0x1B18_0000
 *
 * [ DPUF0 BASE ADDRESS ]
 *
 * - CMU_DPUF0               0x1B80_0000
 * - D_TZPC_DPU0             0x1B81_0000
 * - SYSREG_DPU0             0x1B82_0000 : DRCG (0x0104)
 * - SYSMMU_DPUF0D0_S1_NS    0x1B84_0000
 * - SYSMMU_DPUF0D1_S1_NS    0x1B85_0000
 * - SYSMMU_DPUF0D0_S1_S     0x1B86_0000
 * - SYSMMU_DPUF0D1_S1_S     0x1B87_0000
 * - SYSMMU_DPUF0D0_S2       0x1B88_0000
 * - SYSMMU_DPUF0D1_S2       0x1B89_0000
 * - PPMU_DPUF0D0            0x1B8A_0000
 * - PPMU_DPUF0D1            0x1B8B_0000
 * - DPUF0_DMA               0x1B90_0000
 * - DPUF0_VGEN              0x1B91_0000
 * - DPUF0_C2SERV            0x1B92_0000
 * - DPUF0_DPP0              0x1B93_0000
 * - DPUF0_DPP1              0x1B94_0000
 * - DPUF0_SRAMC             0x1B95_0000
 * - DPUF0_HDR_COMM          0x1B96_0000
 * - DPP_HDR_LSI             0x1B97_0000
 * - DPUF0_C2A               0x1B99_0000
 *
 * [ DPUF1 BASE ADDRESS ]
 *
 * - CMU_DPUF0               0x1BA0_0000
 * - D_TZPC_DPU0             0x1BA1_0000
 * - SYSREG_DPU0             0x1BA2_0000 : DRCG (0x0104)
 * - SYSMMU_DPUF0D0_S1_NS    0x1BA4_0000
 * - SYSMMU_DPUF0D1_S1_NS    0x1BA5_0000
 * - SYSMMU_DPUF0D0_S1_S     0x1BA6_0000
 * - SYSMMU_DPUF0D1_S1_S     0x1BA7_0000
 * - SYSMMU_DPUF0D0_S2       0x1BA8_0000
 * - SYSMMU_DPUF0D1_S2       0x1BA9_0000
 * - PPMU_DPUF0D0            0x1BAA_0000
 * - PPMU_DPUF0D1            0x1BAB_0000
 * - DPUF0_DMA               0x1BB0_0000
 * - DPUF0_VGEN              0x1BB1_0000
 * - DPUF0_C2SERV            0x1BB2_0000
 * - DPUF0_DPP0              0x1BB3_0000
 * - DPUF0_DPP1              0x1BB4_0000
 * - DPUF0_SRAMC             0x1BB5_0000
 * - DPUF0_HDR_COMM          0x1BB6_0000
 * - DPP_HDR_LSI             0x1BB7_0000
 * - DPUF0_C2A               0x1BB9_0000
 *
 * [ HSI0 BASE ADDRESS ]
 *
 * - DP_LINK                 0x1788_0000
 * - USBDPPHY_CTRL           0x178D_0000
 */
...
#define DECON_VERSION_INFO			(0x07030000)
...
#define VMC_CNTL				(0x004C)
#define VMC_LPTS_END				(1 << 7)
#define VMC_ALIGN_VSYNC				(1 << 6)
#define VMC_CMD_OPTION				(1 << 5)
#define VMC_CMD_FORCE_EN			(1 << 4)
#define VMC_CMD_EN				(1 << 3)
#define VMC_EXPIRE_EN				(1 << 2)
#define VMC_LFR_EN				(1 << 1)
#define VMC_MODE_EN				(1 << 0)
...
#define SHD_REG_UP_REQ_AIQE			(1 << 24)
#define SHD_REG_UP_REQ_CMP			(1 << 20)
#define SHD_REG_UP_REQ_WIN(_win)		(1 << (_win))
#define SHD_REG_UP_REQ_FOR_DECON		(0xFFFF)

/*
 * Effectiveness control of shadow update request write
 * When global update request write occurs during frame blank period,
 * the update is postponed to next frame blank start.
 * Set this option to transfer sync cmd after sync cmd is ready.
 * This bit is auto-cleared after finishing to transfer sync cmd
 *  0x0 = Disable frame blank update masking
 *  0x1 = Enable frame blank update masking
 */
#define DECON_SHD_UP_OPTION			(0x0058)
#define SHD_UP_OPTION_MASK_FRAME_BLANK_UPDATE	(1 << 0)
...
#define SEL_SRAM15				(7 << 28)
#define SEL_SRAM14				(7 << 24)
...
#define SEL_SRAM18				(7 << 8)
#define SEL_SRAM17				(7 << 4)
#define SEL_SRAM16				(7 << 0)
...
#define SCALER_PATH_AIQE_F(_v)			((_v) << 25)
#define AIQE_SCALER_ON				SCALER_PATH_AIQE_F(1)
#define SCALER_PATH_AIQE_MASK			(1 << 25)
#define SCALER_PATH_AIQE_GET(_v)		(((_v) >> 25) & 0x1)
#define SCALER_PATH_DQE_F(_v)			((_v) << 24)
#define DQE_SCALER_ON				SCALER_PATH_DQE_F(1)
#define SCALER_PATH_DQE_MASK			(1 << 24)
#define SCALER_PATH_DQE_GET(_v)			(((_v) >> 24) & 0x1)
#define AIQE_PATH_F(_v)				((_v) << 20)
#define AIQE_ON					AIQE_PATH_F(1)
#define AIQE_PATH_MASK				(1 << 20)
#define AIQE_ON_SCALER_ON			(AIQE_ON | AIQE_SCALER_ON)
...
#define ENHANCE_DQE_ON_RCD_ON			(ENHANCE_DQE_ON | ENHANCE_RCD_ON)
...
#define SRAM17_EN_F				(1 << 30)
#define SRAM16_EN_F				(1 << 29)
...
/*
 *-------------------------------------------------------------------
 * PLL_SLEEP_CON is changed from 7.3 version
...
/* for th_error */
#define DBG_INFO_DSIMIF0_0			(0x0F00)
#define TH_ERROR_MASK				(1 << 4)
...
#define PPS46_RC_BUF_THRESH_2(_v)		((_v) << 8)
...
#define PPS64_65_RC_RANGE_PARAM_MASK		(0xffff << 16)
#define PPS64_65_RC_RANGE_PARAM(_v)		((_v) << 16)
#define PPS66_67_RC_RANGE_PARAM_MASK		(0xffff << 0)
#define PPS66_67_RC_RANGE_PARAM(_v)		((_v) << 0)

#define DSC_PPS68_71(_id)			(COMP_OFFSET(_id) + PPS_OFFS + 0x0064)
#define PPS68_69_RC_RANGE_PARAM_MASK		(0xffff << 16)
#define PPS68_69_RC_RANGE_PARAM(_v)		((_v) << 16)
#define PPS70_71_RC_RANGE_PARAM_MASK		(0xffff << 0)
#define PPS70_71_RC_RANGE_PARAM(_v)		((_v) << 0)

#define DSC_PPS72_75(_id)			(COMP_OFFSET(_id) + PPS_OFFS + 0x0068)
#define PPS72_73_RC_RANGE_PARAM_MASK		(0xffff << 16)
#define PPS72_73_RC_RANGE_PARAM(_v)		((_v) << 16)
#define PPS74_75_RC_RANGE_PARAM_MASK		(0xffff << 0)
#define PPS74_75_RC_RANGE_PARAM(_v)		((_v) << 0)

#define DSC_PPS76_79(_id)			(COMP_OFFSET(_id) + PPS_OFFS + 0x006C)
#define PPS76_77_RC_RANGE_PARAM_MASK		(0xffff << 16)
#define PPS76_77_RC_RANGE_PARAM(_v)		((_v) << 16)
#define PPS78_79_RC_RANGE_PARAM_MASK		(0xffff << 0)
#define PPS78_79_RC_RANGE_PARAM(_v)		((_v) << 0)

#define DSC_PPS80_83(_id)			(COMP_OFFSET(_id) + PPS_OFFS + 0x0070)
#define PPS80_81_RC_RANGE_PARAM_MASK		(0xffff << 16)
#define PPS80_81_RC_RANGE_PARAM(_v)		((_v) << 16)
#define PPS82_83_RC_RANGE_PARAM_MASK		(0xffff << 0)
#define PPS82_83_RC_RANGE_PARAM(_v)		((_v) << 0)

#define DSC_PPS84_87(_id)			(COMP_OFFSET(_id) + PPS_OFFS + 0x0074)
#define PPS84_85_RC_RANGE_PARAM_MASK		(0xffff << 16)
#define PPS84_85_RC_RANGE_PARAM(_v)		((_v) << 16)
#define PPS86_87_RC_RANGE_PARAM_MASK		(0xffff << 0)
#define PPS86_87_RC_RANGE_PARAM(_v)		((_v) << 0)
 ...
 * base address : 0x1B95_0000(DPUF0_SRAMC), 0x1BB5_0000(DPUF1_SRAMC)
 * < Dx.offset : id=[8,11]>
 *  D0      D1      D2      D3
...
//===[ G_XXX -- Global ]===
#define SRAMC_G_BASE_ADDR			(0x1B95F000)
#define SRAMC_G1_BASE_ADDR			(0x1BB5F000)

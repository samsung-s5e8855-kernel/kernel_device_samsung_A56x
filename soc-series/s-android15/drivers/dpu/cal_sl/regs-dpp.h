 ...
 * base address : 0x1990_0000(DPUF0_DMA), 0x19B0_0000(DPUF1_DMA)
 * < Layer.offset >
...
/*
 *-------------------------------------------------------------------
 * below register is obsolte.(valid only in under 7.3 version)
 * - RDMA_IRQ
 * Instead, below registers are added from 7.3 version
 * - RDMA_IRQ_CTRL
 * - RDMA_IRQ_MASK
 * - RDMA_IRQ_STATUS
 *-------------------------------------------------------------------
...
#define DMA_SRC_STRIDE_OFFSET			0x0004
#define DMA_STRIDE_SEL				(1 << 31)
#define DMA_STRIDE(_v)				((_v) << 0)
#define DMA_STRIDE_MASK				(0xFFFFFFFF << 0)
...
/* SAJC */
#define IDMA_SAJC_ADDRESS_MODE(_v)		((_v) << 8)
#define IDMA_SAJC_ADDRESS_MODE_MASK		(0x1 << 8)
...
#define IDMA_SBWCL_FR_MODE			(0x2 << 16)
#define IDMA_SBWCL_MODE_MASK			(0x3 << 16)
...
/*
 *-------------------------------------------------------------------
 * below registers are added from 7.3 version
 * - RDMA_IRQ_CTRL
 * - RDMA_IRQ_MASK
 * - RDMA_IRQ_STATUS
 *-------------------------------------------------------------------
 */
#define RDMA_IRQ_CTRL				0x0330
#define IDMA_IRQ_ENABLE				(1 << 0)

#define RDMA_IRQ_MASK				0x0334
#define IDMA_IRQ_MASK_HDR_ERR			(1 << 20)
#define IDMA_IRQ_MASK_TDMC_SCL_ERR		(1 << 17)
#define IDMA_IRQ_MASK_TDMC_DMA_ERR		(1 << 16)
#define IDMA_IRQ_MASK_DPP_CONFIG_ERR		(1 << 14)
#define IDMA_IRQ_MASK_DPP_INST_OFF		(1 << 13)
#define IDMA_IRQ_MASK_DPP_FRAME_DONE		(1 << 12)
#define IDMA_IRQ_MASK_VOTF_ERR			(1 << 9)
#define IDMA_IRQ_MASK_AXI_ADDR_ERR		(1 << 8)
#define IDMA_IRQ_MASK_MO_CONFLICT		(1 << 7)
#define IDMA_IRQ_MASK_FBCD_ERR			(1 << 6)
#define IDMA_IRQ_MASK_RECOVERY_TRG		(1 << 5)
#define IDMA_IRQ_MASK_CONFIG_ERR		(1 << 4)
#define IDMA_IRQ_MASK_READ_SLAVE_ERR		(1 << 3)
#define IDMA_IRQ_MASK_DEADLOCK			(1 << 2)
#define IDMA_IRQ_MASK_INST_OFF_DONE		(1 << 1)
#define IDMA_IRQ_MASK_FRAME_DONE		(1 << 0)
#define IDMA_IRQ_MASK_ALL			(0x1fffff << 0)

#define RDMA_IRQ_STATUS				0x0338
#define IDMA_IRQ_STATUS_HDR_ERR			(1 << 20)
#define IDMA_IRQ_STATUS_TDMC_SCL_ERR		(1 << 17)
#define IDMA_IRQ_STATUS_TDMC_DMA_ERR		(1 << 16)
#define IDMA_IRQ_STATUS_DPP_CONFIG_ERR		(1 << 14)
#define IDMA_IRQ_STATUS_DPP_INST_OFF		(1 << 13)
#define IDMA_IRQ_STATUS_DPP_FRAME_DONE		(1 << 12)
#define IDMA_IRQ_STATUS_VOTF_ERR		(1 << 9)
#define IDMA_IRQ_STATUS_AXI_ADDR_ERR		(1 << 8)
#define IDMA_IRQ_STATUS_MO_CONFLICT		(1 << 7)
#define IDMA_IRQ_STATUS_FBCD_ERR		(1 << 6)
#define IDMA_IRQ_STATUS_RECOVERY_TRG		(1 << 5)
#define IDMA_IRQ_STATUS_CONFIG_ERR		(1 << 4)
#define IDMA_IRQ_STATUS_READ_SLAVE_ERR		(1 << 3)
#define IDMA_IRQ_STATUS_DEADLOCK		(1 << 2)
#define IDMA_IRQ_STATUS_INST_OFF_DONE		(1 << 1)
#define IDMA_IRQ_STATUS_FRAME_DONE		(1 << 0)
#define IDMA_IRQ_STATUS_ALL_CLEAR		(0x1fffff << 0)

#define DPP_CFG_ERROR_IRQ			IDMA_IRQ_STATUS_DPP_CONFIG_ERR
#define IDMA_RECOVERY_START_IRQ			IDMA_IRQ_STATUS_RECOVERY_TRG
#define IDMA_READ_SLAVE_ERROR			IDMA_IRQ_STATUS_READ_SLAVE_ERR
#define IDMA_STATUS_DEADLOCK_IRQ		IDMA_IRQ_STATUS_DEADLOCK
#define IDMA_STATUS_FRAMEDONE_IRQ		IDMA_IRQ_STATUS_FRAME_DONE
...
#define GLB_DPU_VERSION				(0x07030000)
 ...
 *-------------------------------------------------------------------
 */
#define WDMA_IRQ_CTRL				0x0330
#define ODMA_IRQ_ENABLE				(1 << 0)

#define WDMA_IRQ_MASK				0x0334
#define OMDA_IRQ_MASK_WBMUX_CONFIG_ERR		(1 << 14)
#define OMDA_IRQ_MASK_WBMUX_INST_OFF_DONE	(1 << 13)
#define OMDA_IRQ_MASK_WBMUX_FRAME_DONE		(1 << 12)
#define ODMA_IRQ_MASK_VOTF_ERR			(1 << 9)
#define ODMA_IRQ_MASK_CONFIG_ERR		(1 << 4)
#define ODMA_IRQ_MASK_WRITE_SLAVE_ERR		(1 << 3)
#define ODMA_IRQ_MASK_DEADLOCK			(1 << 2)
#define ODMA_IRQ_MASK_INST_OFF_DONE			(1 << 1)
#define ODMA_IRQ_MASK_FRAME_DONE		(1 << 0)
#define ODMA_IRQ_MASK_ALL			(0x721f << 0)

#define WDMA_IRQ_STATUS				0x0338
#define ODMA_IRQ_STATUS_WBMUX_CONFIG_ERR	(1 << 14)
#define ODMA_IRQ_STATUS_WBMUX_INST_OFF_DONE	(1 << 13)
#define ODMA_IRQ_STATUS_WBMUX_FRAME_DONE	(1 << 12)
#define ODMA_IRQ_STATUS_VOTF_ERR		(1 << 9)
#define ODMA_IRQ_STATUS_CONFIG_ERR		(1 << 4)
#define ODMA_IRQ_STATUS_WRITE_SLAVE_ERR		(1 << 3)
#define ODMA_IRQ_STATUS_DEADLOCK		(1 << 2)
#define ODMA_IRQ_STATUS_INST_OFF_DONE		(1 << 1)
#define ODMA_IRQ_STATUS_FRAME_DONE		(1 << 0)
#define ODMA_IRQ_STATUS_ALL_CLEAR		(0x721f << 0)

/* defined for common part of driver only */
#define ODMA_WRITE_SLAVE_ERROR			ODMA_IRQ_STATUS_WRITE_SLAVE_ERR
#define ODMA_STATUS_FRAMEDONE_IRQ		ODMA_IRQ_STATUS_FRAME_DONE
#define ODMA_STATUS_DEADLOCK_IRQ		ODMA_IRQ_STATUS_DEADLOCK
#define ODMA_INST_OFF_DONE_IRQ			ODMA_IRQ_STATUS_INST_OFF_DONE
 ...
 * base address : 0x1992_0000(DPUF0_C2SERV), 0x19B2_0000(DPUF1_C2SERV)
 *
 ...
 * base address : 0x1993_0000(DPUF0_DPP0), 0x19B3_0000(DPUF1_DPP0)
 * < Layer.offset >
...
/*
 *-------------------------------------------------------------------
 * below registers are obsolte.(valid only in under 7.3 version)
 * - DPP_COM_IRQ_CON
 * - DPP_COM_IRQ_MASK
 * - DPP_COM_IRQ_STATUS
 *-------------------------------------------------------------------
 ...
 * base address : 0x1994_0000(DPUF0_DPP1), 0x19B4_0000(DPUF1_DPP1)
 * < Coef.offset >
 ...
 * base address : 0x1996_0000(DPUF0_HDR_COMM), 0x19B6_0000(DPUF1_HDR_COMM)
 * < Layer.offset >
 *  L0      L1      L2      L3      L4      L5      L6      L7
 *  0x0000  0x1000  0x2000  0x3000  0x4000  0x5000  0x6000  0x7000
 *-------------------------------------------------------------------

 ...
 * [ DPU BASE ADDRESS ]
 * - CMU_DPU		     0x1480_0000
 * - D_TZPC_DPU              0x1681_0000
 * - SYSREG_DPU              0x1682_0000 : DPU_MIPI_PHY_CON (0x1008)
 * - MIPI_DSIM0              0x168C_0000
 * - MIPI_DCPHY              0x168E_0000
 * - DECON_MAIN              0x1694_0000
 * - DECON_WIN               0x1695_0000
 * - DECON_SUB               0x1696_0000
 * - DECON0_WINCON           0x1697_0000
 * - DECON1_WINCON           0x1698_0000
 * - DQE0                    0x169B_0000
 *
 * [ DPU BASE ADDRESS ]
 *
 * - SYSREG_DPU0             0x1682_0000 : DRCG (0x0104)
 * - SYSMMU_D0_S1_NS_DPU     0x1690_0000
 * - SYSMMU_D0_S1_S_DPU      0x1691_0000
 * - SYSMMU_D0_S2_DPU_S      0x1692_0000
 * - PPMU_D0_DPU             0x1693_0000
 * - DPU_DMA                 0x1689_0000
 * - DPU_VGEN                0x168A_0000
 * - DPU_C2SERV              0x1688_0000
 * - DPU_DPP                 0x1684_0000
 * - DPU_HDR_LSI             0x1686_0000
 *
 */
...
#define DECON_VERSION_INFO			(0x06270000)
...
#define BLD_SEED_CON				(0x0024)
#define BLD_SEED_CON_FRAME_RESET_HW_DISABLE	(1 << 1)
#define BLD_SEED_CON_FRAME_RESET_SW		(1 << 0)
...
#define SW_TRIG_EN				(1 << 1) //new, along with SW_TRIG_EN
...
/* Only SRAM0/SRAM1/SRAM2/SRAM3/SRAM4 are available in Santa */
...
// DSCC[7] COMP1[5] COMP0[4] WBIF[2] OF0-DSIMIF[0]
// Only WBIF[2] is applicable for decon1
//TBD: Check if macros required for each of the combination
...
#define CWB_ONESHOT_UP_F			(1 << 10)
#define CWB_ONESHOT_F				(1 << 9)
#define CWB_SRC_F(_v)				((_v) << 7)
#define CWB_SRC_MASK				(3 << 7)
#define CWB_SRC_ENH_OUT				(0)
#define CWB_SRC_BND_OUT				(1)
#define CWB_SRC_COMP_OUT			(2)
...
/* SRAM enable/disable sharing for primary/secondary
 * display path */
...
#define BLD_DITH_SEED					(0x0248)
#define BLD_DITH_SEED_BLENDER_DITHER_SHUFFLE_MASK_F(_v)	((_v) << 16)
#define BLD_DITH_SEED_BLENDER_DITHER_SEED_F(_v)		((_v) << 0)
...
#define OF_SIZE_1				(0x0294) // Only decon0
...
#define CLOCK_CON				(0x5000) // Common among decon
/*
...
// comp0 only
#define DSCC_DEBUG_EN(_id)			(COMP_OFFSET(_id) + 0x0080)
#define DSCC_DBG_EN_MASK			(1 << 31)
#define DSCC_DBG_EN(_v)				((_v) << 31)
#define DSCC_DBG_SEL_MASK			(0xffff << 0)
#define DSCC_DBG_SEL(_v)			((_v) << 0)

#define DSCC_DEBUG_DATA(_id)			(COMP_OFFSET(_id) + 0x0084)

/* MDNIE_** register set has been removed in Santa */

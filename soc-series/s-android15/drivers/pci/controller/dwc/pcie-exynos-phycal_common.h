...
extern int exynos_phycal_phy2virt(struct phycal_p2v_map *p2vmap, unsigned int map_size,
			struct phycal_seq *seq, unsigned int seq_size);
extern void exynos_phycal_seq(struct phycal_seq *seq, u32 seq_size, u32 cond0);

...
inline void platform_mif_reg_write(enum scsc_mif_abs_target target, u16 offset, u32 value);
inline u32 platform_mif_reg_read(enum scsc_mif_abs_target target, u16 offset);

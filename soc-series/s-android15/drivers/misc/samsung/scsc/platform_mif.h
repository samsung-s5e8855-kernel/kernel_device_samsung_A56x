...
enum wlbt_irqs {
       PLATFORM_MIF_MBOX,
#if defined(CONFIG_SOC_S5E5515) || defined(CONFIG_SOC_S5E5535) || defined(CONFIG_SOC_S5E8825) \
	|| defined(CONFIG_SOC_S5E8535) || defined(CONFIG_SOC_S5E8835) || defined(CONFIG_SOC_S5E8845) || defined(CONFIG_SOC_S5E8855)
	...
	|| defined(CONFIG_SOC_S5E5515) || defined(CONFIG_SOC_S5E8825) || defined(CONFIG_SOC_S5E5535) \
	|| defined(CONFIG_SOC_S5E8535) || defined(CONFIG_SOC_S5E8835) || defined(CONFIG_SOC_S5E8845) || defined(CONFIG_SOC_S5E8855)

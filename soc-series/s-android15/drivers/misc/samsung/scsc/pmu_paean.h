...
typedef struct
{
	...
	uint16_t lane;
	int runtime_pm;
	/* PCIE SSC enable/disable from host */
	uint32_t pcie_ssc_disable;
...
#define RAMRP_HOSTIF_GEN                                                       \
	RAMRP_HOSTIF_OFFSET(gen)
#define RAMRP_HOSTIF_LANE                                                      \
	RAMRP_HOSTIF_OFFSET(lane)
#define RAMRP_HOSTIF_RUNTIME_PM                                                \
	RAMRP_HOSTIF_OFFSET(runtime_pm)
#define RAMRP_HOSTIF_PCIE_SSC_DISABLE                                          \
	RAMRP_HOSTIF_OFFSET(pcie_ssc_disable)
...
typedef enum {
	...
	PMU_INT_FROM_HOST_PCIE_TIMER_SET_MASK 	= 0x00000020,
	PMU_INT_FROM_HOST_PCIE_SSC_CONFIG     = 0x00000040,

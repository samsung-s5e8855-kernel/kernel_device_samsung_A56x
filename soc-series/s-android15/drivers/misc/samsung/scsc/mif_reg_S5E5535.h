...
/*******************************************/
/* MAILBOX BASE REGISTER LIST		   */
/*******************************************/

#define MAILBOX_CP_WLAN_BASE	0x12A60000
#define MAILBOX_CP_WPAN_BASE	0x12A70000
#define MAILBOX_AP_WLAN_BASE	0x12AC0000
#define MAILBOX_AP_WPAN_BASE	0x12AD0000
#define MAILBOX_GNSS_WLBT_BASE	0x12B20000
#define MAILBOX_APM_WLBT_BASE	0x12B30000
#define MAILBOX_WLBT_AUD_BASE	0x12B40000
#define MAILBOX_WLBT_CHUB_BASE	0x12B50000
#define MAILBOX_AP_WLBTPMU_BASE	0x12B80000
...
#define MIF_INIT                0x0BC   /* MIF_init */
...
#define WLBT_STATES		0x3888	/* STATES [7:0] States index for debugging
					 * 0x00 : Reset
					 * 0x10 : Power up
					 * 0x80 : Power down */
...
#define TCXO_REQ__F		BIT(5)	/* Interrupt enable 0: Disable 1: Enable */
#define TCXO_REQ__R		BIT(4)
#define PWR_REQ__F		BIT(3)
#define PWR_REQ__R		BIT(2)
#define LOCAL_PWR_CFG__F	BIT(1)
#define LOCAL_PWR_CFG__R	BIT(0)
...
#define SELECT			BIT(0)	/* PWR_REQ of WLBT selection signal. 0: APM SW
					 * handles PWR_REQ CLKREQ. 1: PWR_REQ is
					 * connected directly.Interrupt type 0:Edge, 1:Level */

#define MIF_OUT			0x3A20
/* ---- WLBT Interrupt register ---- */
#define RESETREQ_WLBT           BIT(14)
#define WLBT_ACTIVE             BIT(13)
...
#define WLBT_BAAW_ACCESS_CTRL		\
	(WLBT_BAAW_CON_INIT_DONE |	\
	 WLBT_BAAW_CON_EN_WRITE  |	\
...
//<----------------- have to check baaw value
/*******************************************/
/* SYSREG_WLBT			0x10850000 */
/*******************************************/
...
/**
 * SC-510495-DD-1A-BLK_WLBT page 61
*/

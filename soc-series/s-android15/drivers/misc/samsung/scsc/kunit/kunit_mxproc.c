...
ssize_t (*fp_mx_procfs_mx_boot_count_wlan_read)(struct file *file, char __user *user_buf, size_t count, loff_t *ppos) = &mx_procfs_mx_boot_count_wlan_read;

static ssize_t mx_procfs_mx_boot_count_wpan_read(struct file *file, char __user *user_buf, size_t count, loff_t *ppos);
ssize_t (*fp_mx_procfs_mx_boot_count_wpan_read)(struct file *file, char __user *user_buf, size_t count, loff_t *ppos) = &mx_procfs_mx_boot_count_wpan_read;

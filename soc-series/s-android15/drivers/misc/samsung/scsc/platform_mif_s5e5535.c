...
#include <dt-bindings/clock/s5e5535.h>
#endif

#if !defined(CONFIG_SOC_S5E5535)
#error Target processor CONFIG_SOC_S5E5535 not selected
#endif
...
#define MEMLOG_CHECK(x) do { \
	...
	MEMLOG_CHECK(regmap_write(platform->dbus_baaw, BAAW1_D_WLBT_START, WLBT_DBUS_BAAW_1_START >> BAAW_SHIFT_BIT));
	MEMLOG_CHECK(regmap_write(platform->dbus_baaw, BAAW1_D_WLBT_END, WLBT_DBUS_BAAW_1_END >> BAAW_SHIFT_BIT));
	MEMLOG_CHECK(regmap_write(platform->dbus_baaw, BAAW1_D_WLBT_REMAP, paddr >> BAAW_SHIFT_BIT));
	MEMLOG_CHECK(regmap_write(platform->dbus_baaw, BAAW1_D_WLBT_INIT_DONE, WLBT_BAAW_ACCESS_CTRL));

#if IS_ENABLED(CONFIG_EXYNOS_S2MPU) && IS_ENABLED(CONFIG_SCSC_64KB_ALLIGNED_MEMLOG)
	if (!platform->dbus_baaw1_allowed_list_set) {
		ret = exynos_s2mpu_subsystem_set_allowlist(
			WLBT_SUBSYS_NAME,
			platform->mem_start,
			WLBT_DBUS_BAAW_1_END - WLBT_DBUS_BAAW_1_START + 1);
		SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev, "update harx BAAW1: 0x%lx, %ld %s(%d)\n",
			platform->mem_start, WLBT_DBUS_BAAW_1_END - WLBT_DBUS_BAAW_1_START + 1,
...
#define CHECK(x) do { \
	 ...
	 * by the kernel.
	 */
	CHECK(regmap_write(platform->dbus_baaw, BAAW0_D_WLBT_START, WLBT_DBUS_BAAW_0_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->dbus_baaw, BAAW0_D_WLBT_END, WLBT_DBUS_BAAW_0_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->dbus_baaw, BAAW0_D_WLBT_REMAP, platform->mem_start >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_0, WLBT_CBUS_BAAW_0_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_0, WLBT_CBUS_BAAW_0_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_0, WLBT_CBUS_BAAW_0_VALUE >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_1, WLBT_CBUS_BAAW_1_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_1, WLBT_CBUS_BAAW_1_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_1, WLBT_CBUS_BAAW_1_VALUE >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_2, WLBT_CBUS_BAAW_2_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_2, WLBT_CBUS_BAAW_2_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_2, WLBT_CBUS_BAAW_2_VALUE >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_3, WLBT_CBUS_BAAW_3_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_3, WLBT_CBUS_BAAW_3_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_3, WLBT_CBUS_BAAW_3_VALUE >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_4, WLBT_CBUS_BAAW_4_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_4, WLBT_CBUS_BAAW_4_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_4, WLBT_CBUS_BAAW_4_VALUE >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_5, WLBT_CBUS_BAAW_5_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_5, WLBT_CBUS_BAAW_5_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_5, WLBT_CBUS_BAAW_5_VALUE >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_6, WLBT_CBUS_BAAW_6_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_6, WLBT_CBUS_BAAW_6_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_6, WLBT_CBUS_BAAW_6_VALUE >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_7, WLBT_CBUS_BAAW_7_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_7, WLBT_CBUS_BAAW_7_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_7, WLBT_CBUS_BAAW_7_VALUE >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_8, WLBT_CBUS_BAAW_8_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_8, WLBT_CBUS_BAAW_8_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_8, WLBT_CBUS_BAAW_8_VALUE >> BAAW_SHIFT_BIT));
	...
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_9, WLBT_CBUS_BAAW_9_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_9, WLBT_CBUS_BAAW_9_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_9, WLBT_CBUS_BAAW_9_VALUE >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_9, WLBT_BAAW_ACCESS_CTRL));

	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_START_9, &val1);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_END_9, &val2);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_REMAP_9, &val3);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_9, &val4);
	SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev,
		"Updated PBUS_BAAW_9(start, end, remap, enable):(0x%08x, 0x%08x, 0x%08x, 0x%08x)\n",
		val1, val2, val3, val4);

	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_10, WLBT_CBUS_BAAW_10_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_10, WLBT_CBUS_BAAW_10_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_10, WLBT_CBUS_BAAW_10_VALUE >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_10, WLBT_BAAW_ACCESS_CTRL));

	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_START_10, &val1);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_END_10, &val2);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_REMAP_10, &val3);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_10, &val4);
	SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev,
		"Updated PBUS_BAAW_10(start, end, remap, enable):(0x%08x, 0x%08x, 0x%08x, 0x%08x)\n",
		val1, val2, val3, val4);

	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_11, WLBT_CBUS_BAAW_11_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_11, WLBT_CBUS_BAAW_11_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_11, WLBT_CBUS_BAAW_11_VALUE >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_11, WLBT_BAAW_ACCESS_CTRL));

	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_START_11, &val1);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_END_11, &val2);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_REMAP_11, &val3);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_11, &val4);
	SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev,
		"Updated PBUS_BAAW_11(start, end, remap, enable):(0x%08x, 0x%08x, 0x%08x, 0x%08x)\n",
		val1, val2, val3, val4);

	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_12, WLBT_CBUS_BAAW_12_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_12, WLBT_CBUS_BAAW_12_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_12, WLBT_CBUS_BAAW_12_VALUE >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_12, WLBT_BAAW_ACCESS_CTRL));

	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_START_12, &val1);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_END_12, &val2);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_REMAP_12, &val3);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_12, &val4);
	SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev,
		"Updated PBUS_BAAW_12(start, end, remap, enable):(0x%08x, 0x%08x, 0x%08x, 0x%08x)\n",
		val1, val2, val3, val4);

	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_13, WLBT_CBUS_BAAW_13_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_13, WLBT_CBUS_BAAW_13_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_13, WLBT_CBUS_BAAW_13_VALUE >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_13, WLBT_BAAW_ACCESS_CTRL));

	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_START_13, &val1);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_END_13, &val2);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_REMAP_13, &val3);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_13, &val4);
	SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev,
		"Updated PBUS_BAAW_13(start, end, remap, enable):(0x%08x, 0x%08x, 0x%08x, 0x%08x)\n",
		val1, val2, val3, val4);

	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_14, WLBT_CBUS_BAAW_14_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_14, WLBT_CBUS_BAAW_14_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_14, WLBT_CBUS_BAAW_14_VALUE >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_14, WLBT_BAAW_ACCESS_CTRL));

	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_START_14, &val1);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_END_14, &val2);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_REMAP_14, &val3);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_14, &val4);
	SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev,
		"Updated PBUS_BAAW_14(start, end, remap, enable):(0x%08x, 0x%08x, 0x%08x, 0x%08x)\n",
		val1, val2, val3, val4);

	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_START_15, WLBT_CBUS_BAAW_15_START >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_END_15, WLBT_CBUS_BAAW_15_END >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_REMAP_15, WLBT_CBUS_BAAW_15_VALUE >> BAAW_SHIFT_BIT));
	CHECK(regmap_write(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_15, WLBT_BAAW_ACCESS_CTRL));

	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_START_15, &val1);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_END_15, &val2);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_REMAP_15, &val3);
	regmap_read(platform->pbus_baaw, BAAW_C_WLBT_INIT_DONE_15, &val4);
	SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev,
		"Updated PBUS_BAAW_15(start, end, remap, enable):(0x%08x, 0x%08x, 0x%08x, 0x%08x)\n",
		val1, val2, val3, val4);
	...
	/* BOOT_CFG_ACK */
	CHECK(regmap_write(platform->boot_cfg, WLBT_PBUS_BOOT, PMU_BOOT_COMPLETE));
	regmap_read(platform->boot_cfg, WLBT_PBUS_BOOT, &val);
	SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev,
...
static int platform_mif_pmu_reset_release(struct scsc_mif_abs *interface)
{
	...
	// Temporary commented for test. It might be timing issue...
	// CPU is too slow in early bringup
...
#if IS_ENABLED(CONFIG_EXYNOS_S2MPU)
	ret = exynos_s2mpu_backup_subsystem("WLBT");
	if (ret)
		SCSC_TAG_INFO_DEV(PLAT_MIF, platform->dev,
...
#ifdef CONFIG_WLBT_AUTOGEN_PMUCAL
	ret = pmu_cal_progress(platform, pmucal_wlbt.reset_assert, pmucal_wlbt.reset_assert_size);
	if (ret)
		platform_wlbt_regdump(&platform->interface);
	return ret;
#else

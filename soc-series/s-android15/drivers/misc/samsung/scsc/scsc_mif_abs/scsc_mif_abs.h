...
#if defined(CONFIG_WLBT_PMU2AP_MBOX) || defined(CONFIG_SCSC_PCIE_CHIP)
...
#if defined(CONFIG_SOC_S5E9815) || defined(CONFIG_SCSC_PCIE_CHIP) || defined(CONFIG_SOC_S5E8855)
...
/* SMAPPER */
	...
	int  (*mif_pm_qos_cluster_update_request)(struct scsc_mif_abs *interface, struct scsc_mifqos_request *qos_req,

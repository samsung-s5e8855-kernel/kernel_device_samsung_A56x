...
struct scsc_bt_fw_log {
	...
	bool                           btlog_enables_used;
	u8                             fwlog_enables;
	u32                            fwlog_enables0_low;
	u32                            fwlog_enables0_high;
	u32                            fwlog_enables1_low;
	u32                            fwlog_enables1_high;
};
...
struct scsc_bt_service {
	...
	struct file                    *h4_file;
	struct proc_dir_entry          *h4_procfs_dir;
	bool                           h4_users;
	atomic_t                       h4_readers;
	atomic_t                       h4_writers;
	...
	enum {
		SCSC_USER_TYPE_FILE_IO,
		SCSC_USER_TYPE_HCIUART,
	} user_type;

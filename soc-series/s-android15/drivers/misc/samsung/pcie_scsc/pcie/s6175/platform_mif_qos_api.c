...
/* cpucl3: initial-level (lowest freq-level) */
static uint qos_cpucl3_lv[] = {0, 0, 0};
...
MODULE_PARM_DESC(qos_cpucl3_lv, "S5E8535 DVFS Lv of CPUCL3 to apply Min/Med/Max PM QoS");

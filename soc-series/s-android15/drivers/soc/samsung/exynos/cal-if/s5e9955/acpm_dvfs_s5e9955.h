...
struct vclk acpm_vclk_list[] = {
	...
	CMUCAL_ACPM_VCLK(CPUCL3, NULL, NULL, NULL, NULL, 1),
	CMUCAL_ACPM_VCLK(NPU, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(PSP, NULL, NULL, NULL, NULL, 0),
...
asv_g_spec(cpucl2, GET_IDX(CPUCL3), 0x10009010, 8);
asv_g_spec(cpucl1l, GET_IDX(CPUCL2), 0x10009014, 8);
asv_g_spec(cpucl1h, GET_IDX(CPUCL1), 0x10009014, 8);

...
struct vclk acpm_vclk_list[] = {
	...
	CMUCAL_ACPM_VCLK(CPUCL1L, NULL, NULL, NULL, NULL, 1),
	CMUCAL_ACPM_VCLK(CPUCL1H, NULL, NULL, NULL, NULL, 1),
	CMUCAL_ACPM_VCLK(CPUCL2, NULL, NULL, NULL, NULL, 1),
	CMUCAL_ACPM_VCLK(NPU0, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(NPU1, NULL, NULL, NULL, NULL, 0),
	...
	CMUCAL_ACPM_VCLK(MFD, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(INTSCI, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(ICPU, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(DSP, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(DNC, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(GNSS, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(ALIVE, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(CHUB, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(VTS, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(HSI0, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(UFD, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(CHUBVTS, NULL, NULL, NULL, NULL, 0),
	CMUCAL_ACPM_VCLK(UNPU, NULL, NULL, NULL, NULL, 0),
};

unsigned int acpm_vclk_size = ARRAY_SIZE(acpm_vclk_list);

asv_g_spec(cpucl2, GET_IDX(CPUCL2), 0x10009010, 8);
asv_g_spec(cpucl1l, GET_IDX(CPUCL1L), 0x10009014, 8);
asv_g_spec(cpucl1h, GET_IDX(CPUCL1H), 0x10009014, 8);
...
static struct attribute *asv_g_spec_attrs[] = {
	...
	asv_g_spec_attr(cpucl1l),
	asv_g_spec_attr(cpucl1h),

...
ktime_t esca_time_calc(u32 start, u32 end)
{
	...
	return (ktime_t)interval * timer_period;
}
EXPORT_SYMBOL_GPL(esca_time_calc);

ktime_t esca_time_calc_u16(u16 start, u16 end)
{
	u16 interval;
...
EXPORT_SYMBOL_GPL(esca_time_calc_u16);

ktime_t esca_time_calc_s32(u32 start, u32 end)
{
	s32 interval;
...
EXPORT_SYMBOL_GPL(esca_time_calc_s32);

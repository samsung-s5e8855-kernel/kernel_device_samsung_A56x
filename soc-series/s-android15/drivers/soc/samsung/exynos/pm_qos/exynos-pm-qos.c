...
static BLOCKING_NOTIFIER_HEAD(psp_throughput_notifier);
static struct exynos_pm_qos_constraints psp_tput_constraints = {
	.list = PLIST_HEAD_INIT(psp_tput_constraints.list),
	.target_value = PM_QOS_PSP_THROUGHPUT_DEFAULT_VALUE,
	.default_value = PM_QOS_PSP_THROUGHPUT_DEFAULT_VALUE,
	.type = EXYNOS_PM_QOS_MAX,
	.notifiers = &psp_throughput_notifier,
	.lock = __SPIN_LOCK_UNLOCKED(psp_throughput),
	.mlock = __MUTEX_INITIALIZER(psp_tput_constraints.mlock),
};
static struct exynos_pm_qos_object psp_throughput_pm_qos = {
	.constraints = &psp_tput_constraints,
	.name = "psp_throughput",
};

static BLOCKING_NOTIFIER_HEAD(psp_throughput_max_notifier);
static struct exynos_pm_qos_constraints psp_tput_max_constraints = {
	.list = PLIST_HEAD_INIT(psp_tput_max_constraints.list),
	.target_value = PM_QOS_PSP_THROUGHPUT_MAX_DEFAULT_VALUE,
	.default_value = PM_QOS_PSP_THROUGHPUT_MAX_DEFAULT_VALUE,
	.type = EXYNOS_PM_QOS_MIN,
	.notifiers = &psp_throughput_max_notifier,
	.lock = __SPIN_LOCK_UNLOCKED(psp_throughput_max),
	.mlock = __MUTEX_INITIALIZER(psp_tput_max_constraints.mlock),
};
static struct exynos_pm_qos_object psp_throughput_max_pm_qos = {
	.constraints = &psp_tput_max_constraints,
	.name = "psp_throughput_max",
};
...
static struct exynos_pm_qos_object *exynos_pm_qos_array[] = {
	...
	&psp_throughput_pm_qos,
	&psp_throughput_max_pm_qos,
};

					...
					struct modem_data *pdata)
{
	...
	mif_dt_read_u32(np, "mif,int_ap2cp_l2b_status", mbox->int_ap2cp_l2b_status);
#endif
...
#endif
#if IS_ENABLED(CONFIG_CPIF_DYNAMIC_L2B)
	mif_dt_read_u32(np, "mif,irq_cp2ap_l2b_status", mbox->irq_cp2ap_l2b_status);
#endif
...
#endif
#if IS_ENABLED(CONFIG_CPIF_DYNAMIC_L2B)
	of_property_read_u32_array(np, "ap2cp_l2b_msg", pdata->ap2cp_l2b_msg, 2);
	of_property_read_u32_array(np, "cp2ap_l2b_msg", pdata->cp2ap_l2b_msg, 2);
	of_property_read_u32_array(np, "cp2ap_l2b_address", pdata->cp2ap_l2b_address, 2);
	of_property_read_u32_array(np, "cp2ap_l2b_size", pdata->cp2ap_l2b_size, 2);
	of_property_read_u32_array(np, "ap2cp_l2b_size_0", pdata->ap2cp_l2b_size_0, 2);
	of_property_read_u32_array(np, "ap2cp_l2b_size_1", pdata->ap2cp_l2b_size_1, 2);
#endif
...
#endif
#if IS_ENABLED(CONFIG_CPIF_DYNAMIC_L2B)
	mif_dt_read_u32(np, "sbi_ap_l2b_request_mask", pdata->sbi_ap_l2b_request_mask);
	mif_dt_read_u32(np, "sbi_ap_l2b_request_pos", pdata->sbi_ap_l2b_request_pos);
	mif_dt_read_u32(np, "sbi_ap_l2b_index_mask", pdata->sbi_ap_l2b_index_mask);
	mif_dt_read_u32(np, "sbi_ap_l2b_index_pos", pdata->sbi_ap_l2b_index_pos);
	mif_dt_read_u32(np, "sbi_ap_l2b_return_mask", pdata->sbi_ap_l2b_return_mask);
	mif_dt_read_u32(np, "sbi_ap_l2b_return_pos", pdata->sbi_ap_l2b_return_pos);
	mif_dt_read_u32(np, "sbi_cp_l2b_request_mask", pdata->sbi_cp_l2b_request_mask);
	mif_dt_read_u32(np, "sbi_cp_l2b_request_pos", pdata->sbi_cp_l2b_request_pos);
	mif_dt_read_u32(np, "sbi_cp_l2b_index_mask", pdata->sbi_cp_l2b_index_mask);
	mif_dt_read_u32(np, "sbi_cp_l2b_index_pos", pdata->sbi_cp_l2b_index_pos);
	mif_dt_read_u32(np, "sbi_cp_l2b_return_mask", pdata->sbi_cp_l2b_return_mask);
	mif_dt_read_u32(np, "sbi_cp_l2b_return_pos", pdata->sbi_cp_l2b_return_pos);
#endif
...
fail:
	mif_err("CP interface driver probe failed\n");
	return err;
}

...
#define dbg_snapshot_expire_watchdog() do {} while ( 0 )
#define dbg_snapshot_add_bl_item_info(a, b, c) do {} while ( 0 )
#define dbg_snapshot_esca(a, b, c) do {} while ( 0 )
#endif
#include "chub.h"

#if defined(NANOHUB_CPU_CM55)
#define NUM_OF_GPR (25)
#else
...
/*  EXC_RETURN  */
#define EXC_RETURN_PREFIX           0xff
#define EXC_RETURN_PREFIX_BIT       31
#define EXC_RETURN_PREFIX_FIELD     (EXC_RETURN_PREFIX << EXC_RETURN_PREFIX_BIT)

#define EXC_RETURN_RES1             0x1ff
#define EXC_RETURN_RES1_BIT         7
#define EXC_RETURN_RES1_FIELD       (EXC_RETURN_RES1 << EXC_RETURN_RES1_BIT)

#define EXC_RETURN_S                1
#define EXC_RETURN_S_BIT            5
#define EXC_RETURN_S_FIELD          (EXC_RETURN_S << EXC_RETURN_S_BIT)
#define EXC_RETURN_S_NONSEC_STACK   (0 << EXC_RETURN_S_BIT)
#define EXC_RETURN_S_SEC_STACK      (1 << EXC_RETURN_S_BIT)

#define EXC_RETURN_FTYPE            1
#define EXC_RETURN_FTYPE_BIT        4
#define EXC_RETURN_FTYPE_FIELD      (EXC_RETURN_FTYPE << EXC_RETURN_FTYPE_BIT)
#define EXC_RETURN_FTYPE_EXT_STACK  (0 << EXC_RETURN_FTYPE_FIELD)
#define EXC_RETURN_FTYPE_STD_STACK  (1 << EXC_RETURN_FTYPE_FIELD)

#define EXC_RETURN_MODE             1
#define EXC_RETURN_MODE_BIT         3
#define EXC_RETURN_MODE_FIELD       (EXC_RETURN_MODE << EXC_RETURN_MODE_BIT)
#define EXC_RETURN_MODE_HANDLER     (0 << EXC_RETURN_MODE_BIT)
#define EXC_RETURN_MODE_THREAD      (1 << EXC_RETURN_MODE_BIT)

#define EXC_RETURN_SPSEL            1
#define EXC_RETURN_SPSEL_BIT        2
#define EXC_RETURN_SPSEL_FIELD      (EXC_RETURN_SPSEL << EXC_RETURN_SPSEL_BIT)
#define EXC_RETURN_SPSEL_MSP        (0 << EXC_RETURN_SPSEL_BIT)
#define EXC_RETURN_SPSEL_PSP        (1 << EXC_RETURN_SPSEL_BIT)

#define EXC_RETURN_RES0             1
#define EXC_RETURN_RES0_BIT         1
#define EXC_RETURN_RES0_FIELD       (EXC_RETURN_RES0 << EXC_RETURN_RES0_BIT)

#define EXC_RETURN_ES               1
#define EXC_RETURN_ES_BIT           0
#define EXC_RETURN_ES_FIELD         (EXC_RETURN_ES << EXC_RETURN_ES_BIT)
#define EXC_RETURN_ES_NONSEC        (0 << EXC_RETURN_ES_BIT)
#define EXC_RETURN_ES_SEC           (1 << EXC_RETURN_ES_BIT)

#define EXC_RETURN_PAT_MASK         (EXC_RETURN_PREFIX_FIELD | EXC_RETURN_RES1_FIELD | EXC_RETURN_RES0_FIELD)
#define EXC_RETURN_PAT_VAL          (EXC_RETURN_PREFIX_FIELD | EXC_RETURN_RES1_FIELD)

...
enum chub_cache_flush_req {
	/* Host requests CHUB to flush data cache */
	CHUB_CACHE_FLUSH_REQ = 0x11,
	/* CHUB flush data cache done */
	CHUB_CACHE_FLUSH_DONE,
};
...
void ipc_write_shared_reg(uint32_t reg, uint32_t value);
#endif

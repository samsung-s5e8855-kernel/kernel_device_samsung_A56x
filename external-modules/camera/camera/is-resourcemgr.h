...
void pablo_resourcemgr_remove(struct is_resourcemgr *resourcemgr,
...
extern int npu_cam_notify_on_off(bool is_on);
#else
static inline int npu_cam_notify_on_off(bool is_on) { return 0; }
#endif

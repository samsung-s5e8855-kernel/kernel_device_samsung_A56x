...
DEFINE_I2C_DRIVER_PROBE(cis_gc05a3_probe)
{
	int ret;
...
PKV_DEFINE_I2C_DRIVER_REMOVE(cis_gc05a3_remove_i2c)
{
...
#ifdef MODULE
module_driver(sensor_cis_gc05a3_driver, i2c_add_driver,
	i2c_del_driver)
#else

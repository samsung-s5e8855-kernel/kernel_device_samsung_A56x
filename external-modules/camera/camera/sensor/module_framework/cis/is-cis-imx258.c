...
DEFINE_I2C_DRIVER_PROBE(cis_imx258_probe_i2c)
{
	int ret;
	struct is_cis *cis;
...
PKV_DEFINE_I2C_DRIVER_REMOVE(cis_imx258_remove_i2c)
{
...
#ifdef MODULE
module_driver(sensor_cis_imx258_driver, i2c_add_driver,
	i2c_del_driver);
#else

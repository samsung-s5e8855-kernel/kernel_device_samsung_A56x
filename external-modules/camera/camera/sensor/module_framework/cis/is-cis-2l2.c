...
int sensor_2l2_cis_mode_change(struct v4l2_subdev *subdev, u32 mode)
{
	...
	if (ext_info->use_retention_mode == SENSOR_RETENTION_ACTIVATED) {
		...
		case SENSOR_2L2_8064X3024_30FPS:
			...
			cis->ixc_ops->write16(cis->client, 0x602A, 0x0AA0);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x2000);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0xA100);
			break;
		case SENSOR_2L2_8064X2268_30FPS:
			...
			cis->ixc_ops->write16(cis->client, 0x602A, 0x0AA0);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x2000);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0xA400);
			break;
		case SENSOR_2L2_4032X2268_60FPS:
			...
			cis->ixc_ops->write16(cis->client, 0x602A, 0x0AA0);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x2000);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0xAA00);
			break;
		case SENSOR_2L2_1008X756_120FPS:
			...
			cis->ixc_ops->write16(cis->client, 0x602A, 0x0AA0);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0x2000);
			cis->ixc_ops->write16(cis->client, 0x6F12, 0xA700);
			break;
		default:
...
int sensor_2l2_cis_retention_crc_check(struct v4l2_subdev *subdev)
{
	...
	cis->ixc_ops->write16(cis->client, 0x602E, 0xBBD4);
	cis->ixc_ops->read8(cis->client, 0x6F12, &crc_check);
...
int sensor_2l2_cis_stream_off(struct v4l2_subdev *subdev)
{
	...
	cis->ixc_ops->write16(cis->client, 0x6028, 0x2000);
	cis->ixc_ops->write16(cis->client, 0x602A, 0x0ACD);
	cis->ixc_ops->write8(cis->client, 0x6F12, 0x01);
...
int sensor_2l2_cis_set_digital_gain(struct v4l2_subdev *subdev, struct ae_param *dgain)
{
	...
	/* Long digital gain */
	if (is_vendor_wdr_mode_on(cis_data)) {
		ret = cis->ixc_ops->write16(cis->client, 0x3072, long_gain);
		if (ret < 0)
			goto p_err;
	}
...
int sensor_2l2_cis_long_term_exposure(struct v4l2_subdev *subdev)
{
	...
	if (lte_mode->sen_strm_off_on_enable) {
		...
		ret |= cis->ixc_ops->write16(cis->client, 0x6028, 0x2000);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0C10);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x1133);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0D68);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x1133);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0D88);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x1133);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0D98);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x1133);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0B62);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x03C0);

		ret |= cis->ixc_ops->write16(cis->client, 0x0340, 0x7FFF);
		ret |= cis->ixc_ops->write16(cis->client, 0x0342, 0xE500);
		...
		ret |= cis->ixc_ops->write16(cis->client, 0x6028, 0x2000);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0C10);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0361);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0D68);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0361);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0D88);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0361);
		...
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0361);
		ret |= cis->ixc_ops->write16(cis->client, 0x602A, 0x0B62);
		ret |= cis->ixc_ops->write16(cis->client, 0x6F12, 0x0102);

		ret |= cis->ixc_ops->write16(cis->client, 0x0340, 0x24F0);
		ret |= cis->ixc_ops->write16(cis->client, 0x0342, 0x27B0);
...
static int cis_2l2_probe_i2c(struct i2c_client *client,

...
static int sensor_zc569_write_position(struct i2c_client *client, u32 val)
{
	...
	ret = actuator->ixc_ops->addr8_write8(client, ZC569_REG_POS_HIGH, val_high);
	if (ret < 0)
		goto p_err;
	ret = actuator->ixc_ops->addr8_write8(client, ZC569_REG_POS_LOW, val_low);
	if (ret < 0)
		goto p_err;
...
int sensor_zc569_actuator_probe_i2c(struct i2c_client *client,
...
static struct i2c_driver actuator_zc569_driver = {
	...
	.probe	= sensor_zc569_actuator_probe_i2c,

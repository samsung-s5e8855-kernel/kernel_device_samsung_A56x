...
enum is_subscenario_id {
	...
	ISS_SUB_SCENARIO_MERGED_STILL_CAPTURE_GFHDR_SHORT =
		25, /* 25: GFHDR Short capture (HDR Auto/Off) */
	ISS_SUB_SCENARIO_MERGED_STILL_CAPTURE_GFHDR_LONG =
		26, /* 26: GFHDR Long capture (HDR Auto/Off) */

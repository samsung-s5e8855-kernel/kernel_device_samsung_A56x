...
struct is_sensor_cfg {
	...
	u32 binning; /* Pre-defined sensor binning ratio */
	u32 hw_bns; /* Required HW BNS ratio */
	int special_mode;
	...
	u32 emb_vc[CSI_OTF_OUT_CH_NUM];
	int special_vc_sensor_mode;
	u32 dma_num;
	u32 link_vc[CSIS_MAX_NUM_DMA_ATTACH][DMA_VIRTUAL_CH_MAX];
	u32 dma_idx[CSI_VIRTUAL_CH_MAX];
	u32 dma_vc[CSI_VIRTUAL_CH_MAX];

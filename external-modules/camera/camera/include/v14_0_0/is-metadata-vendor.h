...
enum aa_capture_intent {
	...
	AA_CAPTURE_INTENT_STILL_CAPTURE_REPEATED_MULTI_FRAME_LIST = 167,
	...
	AA_CAPTURE_INTENT_STILL_CAPTURE_AI_ZOOM_NN = 171,
	AA_CAPTURE_INTENT_STILL_CAPTURE_AI_ZOOM_NN_AEB = 172,
	AA_CAPTURE_INTENT_STILL_CAPTURE_AI_ZOOM_SR_NN = 173,
	...
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_MOON = 90003,
	AA_CAPTURE_INTENT_STILL_CAPTURE_REMOSAIC_EXPOSURE_DYNAMIC_SHOT = 90004,
};
...
enum aa_captureExtraInfo_mask {
	...
	AA_CAPTURE_EXTRA_INFO_CROPED_REMOSAIC_SEAMLESS = 1 << 1, /* bit 1 */
...
enum aa_exposure_table {
	AA_EXPOSURE_TABLE_APP_SCENARIO = 0,
	AA_EXPOSURE_TABLE_NATIVE,
};
...
struct camera2_aa_ctl {
	...
	enum aa_exposure_table vendor_exposureTable;
...
struct camera2_me_rta_capture_result {
	...
	char meMvMajorVersion[4];
	char meMvMinorVersion[4];
};

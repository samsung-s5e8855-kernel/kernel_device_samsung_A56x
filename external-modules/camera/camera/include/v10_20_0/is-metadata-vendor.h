...
#define CAMERA2_MAX_IPC_VENDOR_LENGTH 5630
#else
#define CAMERA2_MAX_IPC_VENDOR_LENGTH 3130
#endif
...
enum is_subscenario_id {
	...
	ISS_SUB_SCENARIO_STILL_PREVIEW_PRO_MODE =
		3, /* 3: ProMode Preview (HDR Off) : just Innovative project */
	...
	ISS_SUB_SCENARIO_CROPPED_REMOSAIC_CAPTURE_SINGLE =
		21, /* 21: Remosaic cropped zoom capture single (HDR Auto) */
	ISS_SUB_SCENARIO_MERGED_STILL_REMOSAIC_CAPTURE_MFHDR =
		22, /* 22: Remosaic MFHDR Capture ( HDR Auto/Off ) */
	...
	ISS_SUB_SCENARIO_STILL_PREVIEW_3RD_PARTY_HIGH =
		71, /* 71: 3rd Party Preview/Video Height >= 940 */
	ISS_SUB_SCENARIO_STILL_PREVIEW_3RD_PARTY_MID =
		72, /* 72: 3rd Party Preview/Video Height 940 ~ 720 */
	ISS_SUB_SCENARIO_STILL_PREVIEW_3RD_PARTY_LOW =
		73, /* 73: 3rd Party Preview/Video Height < 720 */
	ISS_SUB_SCENARIO_STILL_CAPTURE_3RD_PARTY_HIGH =
		74, /* 74: 3rd Party Capture Height >= 1800 */
	ISS_SUB_SCENARIO_STILL_CAPTURE_3RD_PARTY_MID =
		75, /* 75: 3rd Party Capture Height 1800 ~ 1080 */
...
enum aa_ae_lock { AA_AE_LOCK_OFF = 1, AA_AE_LOCK_ON };
...
struct camera2_object_detect_uctl {
	...
	uint16_t object_roi
		[RECT_IDX_MAX]; /* RECT_IDX_LEFT, RECT_IDX_TOP, RECT_IDX_WIDTH, RECT_IDX_HEIGHT */
};
/** \brief

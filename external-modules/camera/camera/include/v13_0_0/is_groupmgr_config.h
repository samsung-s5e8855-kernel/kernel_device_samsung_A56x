...
#define GROUP_ID_MTNR           32
#define GROUP_ID_MSNR           33
#define GROUP_ID_YUVP           34
#define GROUP_ID_MCS0           35
#define GROUP_ID_MAX            36
...
#define GROUP_SLOT_LIC GROUP_SLOT_MLSC
...
#define GROUP_ID_3AA0 GROUP_ID_BYRP0
#define GROUP_ID_3AA1 GROUP_ID_BYRP1
#define GROUP_ID_3AA2 GROUP_ID_BYRP2
#define GROUP_ID_3AA3 GROUP_ID_BYRP3
#define GROUP_ID_3AA_MAX 4

#define IS_SENSOR_GROUP(id) ((id) <= GROUP_ID_SS6)
...
static const u32 slot_to_gid[GROUP_SLOT_MAX] = {
	...
	[GROUP_SLOT_MTNR] = GROUP_ID_MTNR,
	[GROUP_SLOT_MSNR] = GROUP_ID_MSNR,
	[GROUP_SLOT_YUVP] = GROUP_ID_YUVP,
	[GROUP_SLOT_MCS] = GROUP_ID_MCS0,
};

static const char *const group_id_name[GROUP_ID_MAX + 1] = { [GROUP_ID_SS0] = "G:SS0",
	[GROUP_ID_SS1] = "G:SS1",
	[GROUP_ID_SS2] = "G:SS2",
	[GROUP_ID_SS3] = "G:SS3",
	[GROUP_ID_SS4] = "G:SS4",

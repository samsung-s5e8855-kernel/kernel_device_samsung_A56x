...
enum is_video_dev_num {
	...
	IS_VIDEO_PAF3S,
	IS_VIDEO_BYRP0 = 20,
	IS_VIDEO_BYRP = IS_VIDEO_BYRP0,
	IS_VIDEO_BYRP1,
	IS_VIDEO_BYRP2,
	IS_VIDEO_BYRP3,
	IS_VIDEO_BYRP4,
	IS_VIDEO_RGBP0 = 30,
	IS_VIDEO_RGBP = IS_VIDEO_RGBP0,
	IS_VIDEO_RGBP1,
	IS_VIDEO_RGBP2,
	IS_VIDEO_RGBP3,
	IS_VIDEO_YUVSC0 = 40,
	...
	/* DOF = 59 */
	IS_VIDEO_MTNR = 60,
	IS_VIDEO_MCFP = IS_VIDEO_MTNR,
	IS_VIDEO_MSNR = 70,
	IS_VIDEO_YUVP = 80,
	IS_VIDEO_MCSC = 90,
	IS_VIDEO_MCSC0 = IS_VIDEO_MCSC,
	/* JPEG: 100 ~ 109 */
	...
	IS_LVN_RGBP0_SAT = IS_LVN_RGBP_SAT,
	IS_LVN_RGBP0_HIST = IS_LVN_RGBP_HIST,
	...
	IS_LVN_YUVP_CR,
	IS_LVN_YUVP_RTA_INFO = IS_LVN_YUVP_CR,
	IS_LVN_MCSC_P0 = 580,
	IS_LVN_MCSC_P1,
	IS_LVN_MCSC_P2,
	IS_LVN_MCSC_P3,
...
static const char *const vn_name[IS_VIDEO_MAX_NUM + 1] = { [IS_VIDEO_COMMON] = "V:CMN",
	...
	[IS_LVN_MSNR_CAPTURE_LMEDS] = "V:MSNR_CAPTURE_LMEDS",
	[IS_LVN_MSNR_CR] = "V:MSNR_CR",

	[IS_LVN_YUVP_SEG] = "V:YUVP_SEG",
	[IS_LVN_YUVP_DRC] = "V:YUVP_DRC",
	[IS_LVN_YUVP_CLAHE] = "V:YUVP_CLAHE",
	[IS_LVN_YUVP_PCCHIST_R] = "V:YUVP_PCCHIST_R",
	[IS_LVN_YUVP_PCCHIST_W] = "V:YUVP_PCCHIST_W",
	...
	[IS_LVN_MLSC0_CR] = "V:MLSC0_CR",
	[IS_LVN_MLSC1_CR] = "V:MLSC1_CR",
	[IS_LVN_MLSC2_CR] = "V:MLSC2_CR",
	[IS_LVN_MLSC3_CR] = "V:MLSC3_CR",

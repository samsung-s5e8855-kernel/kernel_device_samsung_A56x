...
#define KEEP_FRAME_TICK_FAST_LAUNCH 4
...
enum is_dvfs_scenario_vendor {
	...
	IS_DVFS_SCENARIO_VENDOR_PSM = 8,
	IS_DVFS_SCENARIO_VENDOR_SINGLE_TAKE = 9,
};
...
#define is_set_dvfs_fast_launch(d) do_nothing
#define is_set_static_dvfs(d, i, s) ({ 0; })

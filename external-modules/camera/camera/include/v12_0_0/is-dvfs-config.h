...
enum IS_DVFS_SN {
	...
	IS_DVFS_SN_REAR_SINGLE_PHOTO_60,
	...
	IS_DVFS_SN_REAR_SINGLE_VIDEO_8K30_DLNR,
	IS_DVFS_SN_REAR_SINGLE_VIDEO_QHD30_SUPERSTEADY,
	IS_DVFS_SN_REAR_SINGLE_VIDEO_QHD60_SUPERSTEADY,
	...
	IS_DVFS_SN_TRIPLE_VIDEO_UHD30_HF,
	IS_DVFS_SN_TRIPLE_VIDEO_FHD60,
	IS_DVFS_SN_TRIPLE_VIDEO_UHD60,
	IS_DVFS_SN_TRIPLE_VIDEO_UHD60_HF,
...
static struct is_dvfs_dt_t is_dvfs_dt_arr[IS_DVFS_SN_END] = {
	...
	{
		.parse_scenario_nm = "rear_single_photo_60_",
		.scenario_id = IS_DVFS_SN_REAR_SINGLE_PHOTO_60,
		.keep_frame_tick = -1,
	},
	{
	...
	{
		.parse_scenario_nm = "rear_single_video_8k30_dlnr_",
		.scenario_id = IS_DVFS_SN_REAR_SINGLE_VIDEO_8K30_DLNR,
		.keep_frame_tick = -1,
	},
	{
		.parse_scenario_nm = "rear_single_video_qhd30_supersteady_",
		.scenario_id = IS_DVFS_SN_REAR_SINGLE_VIDEO_QHD30_SUPERSTEADY,
		.keep_frame_tick = -1,
	},
	{
		.parse_scenario_nm = "rear_single_video_qhd60_supersteady_",
		.scenario_id = IS_DVFS_SN_REAR_SINGLE_VIDEO_QHD60_SUPERSTEADY,
		.keep_frame_tick = -1,
	},
	{
	...
	{
		.parse_scenario_nm = "front_single_video_uhd30_hf_",
		.scenario_id = IS_DVFS_SN_FRONT_SINGLE_VIDEO_UHD30_HF,
		.keep_frame_tick = -1,
	},
	{
	...
	{
		.parse_scenario_nm = "front_single_video_uhd60_hf_",
		.scenario_id = IS_DVFS_SN_FRONT_SINGLE_VIDEO_UHD60_HF,
		.keep_frame_tick = -1,
	},
	{
	...
	{
		.parse_scenario_nm = "front_single_video_uhd120_hf_",
		.scenario_id = IS_DVFS_SN_FRONT_SINGLE_VIDEO_UHD120_HF,
		.keep_frame_tick = -1,
	},
	{
	...
	{
		.parse_scenario_nm = "triple_video_uhd30_hf_",
		.scenario_id = IS_DVFS_SN_TRIPLE_VIDEO_UHD30_HF,
		.keep_frame_tick = -1,
	},
	{
	...
	{
		.parse_scenario_nm = "triple_video_uhd60_hf_",
		.scenario_id = IS_DVFS_SN_TRIPLE_VIDEO_UHD60_HF,
		.keep_frame_tick = -1,
	},
	{

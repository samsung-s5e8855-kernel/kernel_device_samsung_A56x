...
enum IS_DVFS_SN {
	...
	IS_DVFS_SN_REAR_SINGLE_SINGLETAKE,
	/* rear tele sensor scenarios */
	...
	IS_DVFS_SN_FRONT_SINGLE_REMOSAIC_PHOTO,
	IS_DVFS_SN_FRONT_SINGLE_REMOSAIC_CAPTURE,
	IS_DVFS_SN_FRONT_SINGLE_FASTAE,
	IS_DVFS_SN_FRONT_SINGLE_VT,
	IS_DVFS_SN_FRONT_SINGLE_SINGLETAKE,
	/* pip scenarios */
	IS_DVFS_SN_PIP_DUAL_FASTAE,
...
static struct is_dvfs_dt_t is_dvfs_dt_arr[IS_DVFS_SN_END] = {
	...
	{
		.parse_scenario_nm = "rear_single_video_hd120_",
		.scenario_id = IS_DVFS_SN_REAR_SINGLE_VIDEO_HD120,
		.keep_frame_tick = -1,
	},
	{
	...
	{
		.parse_scenario_nm = "rear_single_singletake_",
		.scenario_id = IS_DVFS_SN_REAR_SINGLE_SINGLETAKE,
		.keep_frame_tick = -1,
	},
	/* rear tele sensor scenarios */
	{
	...
	{
		.parse_scenario_nm = "front_single_remosaic_photo_",
		.scenario_id = IS_DVFS_SN_FRONT_SINGLE_REMOSAIC_PHOTO,
		.keep_frame_tick = -1,
	},
	{
		.parse_scenario_nm = "front_single_remosaic_capture_",
		.scenario_id = IS_DVFS_SN_FRONT_SINGLE_REMOSAIC_CAPTURE,
		.keep_frame_tick = IS_DVFS_CAPTURE_TICK,
	},
	{
	...
	{
		.parse_scenario_nm = "front_single_singletake_",
		.scenario_id = IS_DVFS_SN_FRONT_SINGLE_SINGLETAKE,
		.keep_frame_tick = -1,
	},
	/* pip scenarios */
	{
		.parse_scenario_nm = "pip_dual_fastae_",
		.scenario_id = IS_DVFS_SN_PIP_DUAL_FASTAE,
		.keep_frame_tick = -1,
	},
	{

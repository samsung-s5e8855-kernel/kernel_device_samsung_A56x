...
enum pablo_hic_cstat_frame_start {
	...
	FRAME_START_MAX,
	FRAME_START_PCSI_DVA_LOW = FRAME_START_MAX,
};
...
enum pablo_hic_cstat_cdaf_end {
	...
	CDAF_MAX,
	CDAF_CDAF_RAW_DVA_LOW = CDAF_MAX,
	CDAF_PDAF_TAIL_DVA_LOW = CDAF_MAX,
	CDAF_LASER_AF_DVA_LOW = CDAF_MAX,
};
...
enum pablo_hic_pdp_stat0_end {
	...
	PDP_STAT0_DVA_HIGH,
	PDP_STAT0_MAX,
	PDP_STAT0_DVA_LOW = PDP_STAT0_MAX,
};
...
enum pablo_hic_pdp_stat1_end {
	...
	PDP_STAT1_DVA_HIGH,
	PDP_STAT1_MAX,
	PDP_STAT1_DVA_LOW = PDP_STAT1_MAX,
};
...
enum pablo_hic_control_sensor {
	...
	CONTROL_SENSOR_MAX,
	CONTROL_SENSOR_BUF_DVA_LOW = CONTROL_SENSOR_MAX,
};

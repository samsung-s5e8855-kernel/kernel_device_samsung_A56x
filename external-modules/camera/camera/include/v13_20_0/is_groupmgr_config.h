...
#define GROUP_ID_3AA_MAX	3
#define GROUP_ID_BYRP           3
#define GROUP_ID_RGBP           4
#define GROUP_ID_MCS0           5
#define GROUP_ID_PAF0           6
#define GROUP_ID_PAF1           7
#define GROUP_ID_PAF2           8
#define GROUP_ID_MCFP           9
#define GROUP_ID_YUVP           10
#define GROUP_ID_LME0           11
...
#define GROUP_ID_SS6            18
#define GROUP_ID_SS7            19
#define GROUP_ID_SS8            20

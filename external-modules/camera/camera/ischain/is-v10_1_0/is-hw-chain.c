...
static const u32 s2mpu_address_table[SYSMMU_DMAX_S2] = {
	...
	[SYSMMU_D0_CSIS_S2] = 0x17180000,
	[SYSMMU_D1_CSIS_S2] = 0x171B0000,
	[SYSMMU_D2_CSIS_S2] = 0x171E0000,
	[SYSMMU_D0_CSTAT_S2] = 0x18560000,
	[SYSMMU_D0_BYRP_S2] = 0x17450000,
	[SYSMMU_D1_BYRP_RGBP_S2] = 0x17550000,
	[SYSMMU_D2_BYRP_RGBP_S2] = 0x17590000,
	[SYSMMU_D0_MCFP_MCSC_S2] = 0x15C90000,
	[SYSMMU_D1_MCFP_MCSC_S2] = 0x15CC0000,
	[SYSMMU_D2_MCFP_MCSC_S2] = 0x15CF0000,
	[SYSMMU_D3_MCFP_MCSC_S2] = 0x15D20000,
	[SYSMMU_D4_MCFP_MCSC_S2] = 0x15D50000,
	[SYSMMU_D0_YUVP_S2] = 0x18090000,
	[SYSMMU_D1_YUVP_S2] = 0x180C0000,
	[SYSMMU_D_LME_S2] = 0x176C0000,
};
...
int is_hw_camif_cfg(void *sensor_data)
{
	...
	fid_loc = &sensor->cfg[sensor->nfi_toggle]->fid_loc;

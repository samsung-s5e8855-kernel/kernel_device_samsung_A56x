...
#define CONFIG_MTNR_32B_PA_ENABLE	0
#define SBWC_QUALITY_MODE	2

#define CSIS_COMP_BLOCK_WIDTH		256
#define CSIS_COMP_BLOCK_HEIGHT		1

#define MLSC_COMP_BLOCK_WIDTH 32
#define MLSC_COMP_BLOCK_HEIGHT 4
...
#define MTNR0_COMP_BLOCK_WIDTH		32
#define MTNR0_COMP_BLOCK_HEIGHT		4
#define MTNR1_COMP_BLOCK_WIDTH		32
#define MTNR1_COMP_BLOCK_HEIGHT		4

/* TODO: FIXME */
#define MSNR_COMP_BLOCK_WIDTH		32
#define MSNR_COMP_BLOCK_HEIGHT		4
...
/* #define MTNR_STRIP_OTF_MARGIN_CROP	256 */ /* TODO: need to check */
#define ENABLE_LMEDS
...
#define SBWC_BASE_ALIGN_MASK SBWC_STRIDE_32B_ALIGN
...
#define CHECK_TIMEOUT_PANIC_HW(id)                                                                 \
	((id == DEV_HW_MTNR0) || (id == DEV_HW_MTNR1) || (id == DEV_HW_MSNR) ||                    \
		(id == DEV_HW_YPP) || (id == DEV_HW_MCSC0))
#endif
...
#define SECURE_CAMERA_MEM_SIZE		(0x00C00000)	/* 4MB aligned for CMA */
...
#define CHECK_NEED_KVADDR_LVN_ID(vid)                                                              \
	((0) || ((vid) == IS_LVN_MTNR0_CR) || ((vid) == IS_LVN_MTNR1_CR) ||                        \
		...
		((vid) == IS_LVN_MCSC_CR) || ((vid) == IS_LVN_MLSC0_CR) ||                         \
		((vid) == IS_LVN_MLSC1_CR) || ((vid) == IS_LVN_MLSC2_CR) ||                        \
		((vid) == IS_LVN_MLSC3_CR)) ||                                                     \
		((vid) == IS_LVN_MTNR_OUTPUT_MV_GEOMATCH)

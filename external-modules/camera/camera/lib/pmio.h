...
#define __PMIO_MAX_NUM_EXT_HDR	256
#define PMIO_MAX_NUM_EXT_HDR	(__PMIO_MAX_NUM_EXT_HDR + 1)
...
static inline const char *pmio_formatter_name(enum pmio_formatter_type t)
{
	return pmio_formatter_names[t];
}

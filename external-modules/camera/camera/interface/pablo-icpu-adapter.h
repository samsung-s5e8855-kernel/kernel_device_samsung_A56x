...
typedef u32 (*pablo_get_ch_fn)(u32 instance);

#define CALL_ADT_OPS(adt, op, args...)                                                             \
	(likely(is_debug_support_crta()) && (adt && (adt)->ops && (adt)->ops->op) ?                \
			((adt)->ops->op(adt, args)) :                                              \
			0)
...
struct pablo_icpu_adt_ops {
	...
	int (*register_get_ch_fn)(struct pablo_icpu_adt *icpu_adt, u32 instance, pablo_get_ch_fn cb);
};
...
#define CALL_ADT_MSG_OPS(adt, op, args...)                                                         \
	(likely(is_debug_support_crta()) && (adt && (adt)->msg_ops && (adt)->msg_ops->op) ?        \
			((adt)->msg_ops->op(adt, args)) :                                          \
			0)
...
struct pablo_icpu_adt_msg_ops {
	...
	int (*send_msg_cstat_cdaf_end)(struct pablo_icpu_adt *icpu_adt, u32 instance,
				       void *cb_user, void *cb_ctx,
				       u32 fcount, struct pablo_crta_buf_info *stat_buf);
	...
	int (*send_msg_cstat_frame_end)(struct pablo_icpu_adt *icpu_adt, u32 instance,
					void *cb_user, void *cb_ctx,
					u32 fcount, struct pablo_crta_buf_info *shot_buf,

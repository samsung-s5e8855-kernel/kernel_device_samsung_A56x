...
static void pablo_icpu_hw_set_mbox_debug_reg_kunit_test(struct kunit *test)
{
	struct icpu_serial_dbg_reg_info sdri[2] = { 0, };

	test_pdata.dbg_reg_info.num_sdri = sizeof(sdri)/sizeof(struct icpu_serial_dbg_reg_info);
	test_pdata.dbg_reg_info.sdri = sdri;
	pablo_icpu_hw_set_mbox_debug_reg(&test_pdata, 0, 0xBABEFACE);
	test_pdata.dbg_reg_info.num_sdri = 0;
	test_pdata.dbg_reg_info.sdri = NULL;
}
...
static struct kunit_case pablo_icpu_hw_itf_kunit_test_cases[] = {
	...
	KUNIT_CASE(pablo_icpu_hw_set_mbox_debug_reg_kunit_test),
	{},
};

...
#include "hardware/sfr/is-sfr-rgbp-v13_20.h"
...
static void pablo_hw_api_rgbp_hw_is_occurred1_kunit_test(struct kunit *test)
{
	...
	u32 err_interrupt_list[] = {
		...
		INTR1_RGBP_VOTF0GLOBALERROR,
		INTR1_RGBP_VOTF0LOSTCONNECTION,
		INTR1_RGBP_VOTF0LOSTFLUSH,
		INTR1_RGBP_VOTF1LOSTFLUSH,
		...
		/*INTR1_RGBP_SATFLAG_SP_CONV_DBG_CNT_ERR,*/
...
static void pablo_hw_api_rgbp_hw_s_block_bypass_kunit_test(struct kunit *test)
{
	...
	val = RGBP_GET_F(test_ctx.pmio, RGBP_R_RGB_LUMAADAPLSC_BYPASS,
	...
	KUNIT_EXPECT_EQ(test, val, 0);
	utc_flag = (utc_flag && !val);
	val = RGBP_GET_F(test_ctx.pmio, RGBP_R_YUV_YUV444TO422_ISP_BYPASS,
...
struct kunit_suite pablo_hw_api_rgbp_kunit_test_suite = {
	.name = "pablo-hw-api-rgbp-v13_20-kunit-test",

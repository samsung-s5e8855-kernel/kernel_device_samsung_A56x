...
static void pablo_hw_api_common_ctrl_otf_disable_kunit_test(struct kunit *test)
{
	...
	KUNIT_EXPECT_EQ(test, GET_CR(CMN_CTRL_R_IP_PROCESSING), 0);
	KUNIT_EXPECT_EQ(test, GET_CR(CMN_CTRL_R_SW_APB_RESET), 1);
}

static void pablo_hw_api_common_ctrl_m2m_disable_kunit_test(struct kunit *test)
{
	struct pablo_common_ctrl *pcc = &test_ctx.pcc_m2m;
...
static struct kunit_case pablo_hw_api_common_ctrl_kunit_test_cases[] = {
	...
	KUNIT_CASE(pablo_hw_api_common_ctrl_m2m_disable_kunit_test),
...
static int pablo_hw_api_common_ctrl_kunit_test_init(struct kunit *test)
{
	...
	pdrv = pablo_common_ctrl_api_get_platform_driver_v1_4();
...
static struct kunit_suite pablo_hw_api_common_ctrl_v1_4_kunit_test_suite = {
	.name = "pablo-hw-api-common-ctrl-v1_4-kunit-test",
...
define_pablo_kunit_test_suites(&pablo_hw_api_common_ctrl_v1_4_kunit_test_suite);

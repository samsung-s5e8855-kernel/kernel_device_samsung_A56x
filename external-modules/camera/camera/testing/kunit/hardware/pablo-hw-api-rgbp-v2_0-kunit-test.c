...
static void pablo_hw_api_rgbp_check_cin_fifo(struct kunit *test, u32 set_id)
{
	u32 set_val, expected_val;
...
static void pablo_hw_api_rgbp_check_cout_fifo(struct kunit *test)
{
	...
	set_val = RGBP_GET_F(test_ctx.pmio, RGBP_R_IP_USE_OTF_PATH,
	...
	set_val = RGBP_GET_F(test_ctx.pmio, RGBP_R_YUV_COUTFIFO_ENABLE,
...
static void pablo_hw_api_rgbp_hw_s_core_kunit_test(struct kunit *test)
{
	...
	/* rgbp_hw_s_cin_fifo() */
	pablo_hw_api_rgbp_check_cin_fifo(test, set_id);
	/* rgbp_hw_s_cout_fifo() */
...
static void pablo_hw_api_rgbp_hw_g_input_dva_kunit_test(struct kunit *test)
{
	...
	id = RGBP_RDMA_BYR;
	rgbp_hw_g_input_dva(&test_ctx.param_set, instance, id, &cmd, &in_rgb);
...
static void pablo_hw_api_rgbp_hw_g_output_dva_kunit_test(struct kunit *test)
{
	...
	id = RGBP_WDMA_HF;
	rgbp_hw_g_output_dva(&test_ctx.param_set, instance, id, &cmd, &out_yuv);

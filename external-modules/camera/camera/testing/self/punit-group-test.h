...
static struct punit_group_test_map map_static_info[] = {
	...
	[6].idx = 6,
	[6].key = "sensor_ex_mode",
	[6].count = 1,

	[7].idx = 7,
	[7].key = "sensor_ex_mode_format",
	[7].count = 1,
	...
	[10].idx = 10,
	[10].key = "enable",
	[10].count = GROUP_SLOT_MAX,

	[11].idx = 10 + GROUP_SLOT_MAX,
	[11].key = "input",
	[11].count = GROUP_SLOT_MAX,
};

...
enum punit_criteria_dvfs_variable {
	...
	PUNIT_DVFS_VAR_THROTT,
	PUNIT_DVFS_VAR_CAM_LV,
	PUNIT_DVFS_VAR_ISP_LV,
	PUNIT_DVFS_VAR_INTCAM_LV,
	PUNIT_DVFS_VAR_MIF_LV,
	PUNIT_DVFS_VAR_INT_LV,
	PUNIT_DVFS_VAR_ICPU_LV,
	PUNIT_DVFS_VAR_MAX,
};

...
static void pst_get_size_of_lme_input(void *param, u32 align, size_t *size)
{
	...
	pst_get_size_by_format(
		lme_in->input_format, lme_in->input_plane, stride, lme_in->cur_input_height, size);
}

...
static int _is_hw_cstat_shot(struct is_hw_ip *hw_ip, struct is_frame *frame, ulong hw_map)
{
	...
	if (unlikely(!hw->cur_iq_set.size)) {
		if (p_set->dma_output_lme_ds0.width)
			conf_default.lmeds_w = p_set->dma_output_lme_ds0.width;
		else
			conf_default.lmeds_w = p_set->dma_output_lme_ds1.width;
		if (p_set->dma_output_lme_ds0.height)
			conf_default.lmeds_h = p_set->dma_output_lme_ds0.height;
		else
			conf_default.lmeds_h = p_set->dma_output_lme_ds1.height;

		conf_default.lmeds1_w = p_set->dma_output_lme_ds1.dma_crop_width;
		conf_default.lmeds1_h = p_set->dma_output_lme_ds1.dma_crop_height;

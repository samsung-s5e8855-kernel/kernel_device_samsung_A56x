...
#ifndef IS_SFR_CSIS_PDP_TOP_V14_0_H
#define IS_SFR_CSIS_PDP_TOP_V14_0_H
...
enum csis_top_sw_reset_core_map {
	SWRESET_CORE_IBUF = 0,
	SWRESET_CORE_MPC = 1,
	SWRESET_CORE_MCB0 = 2,
	SWRESET_CORE_MCB1 = 3,
	SWRESET_CORE_BNS = 4,
	SWRESET_CORE_ISP2VHD_BYRP0 = 7,
	SWRESET_CORE_ISP2VHD_BYRP1 = 8,
	SWRESET_CORE_ISP2VHD_BYRP2 = 9,
	SWRESET_CORE_ISP2VHD_BYRP3 = 10,
	SWRESET_CORE_FRM_ID_DEC = 12,
	SWRESET_CORE_NFI_DEC0 = 13,
	SWRESET_CORE_NFI_DEC1 = 14,
	SWRESET_CORE_NFI_DEC2 = 15,
	SWRESET_CORE_NFI_DEC3 = 16,
	SWRESET_CORE_NFI_DEC4 = 17,
	SWRESET_CORE_NFI_DEC5 = 18,
	SWRESET_CORE_NFI_DEC6 = 19,
	SWRESET_CORE_ISP2VHD_DMA0 = 20,
	SWRESET_CORE_ISP2VHD_DMA1 = 21,
	SWRESET_CORE_ISP2VHD_DMA2 = 22,
	SWRESET_CORE_ISP2VHD_DMA3 = 23,
	SWRESET_CORE_ISP2VHD_DMA4 = 24,
};

#define CSIS_TOP_SW_RESET_MASK                                                                     \
	((0) | (1 << SWRESET_CORE_IBUF) | (1 << SWRESET_CORE_MPC) | (1 << SWRESET_CORE_MCB0) |     \
		(1 << SWRESET_CORE_MCB1) | (1 << SWRESET_CORE_BNS) |                               \
		(1 << SWRESET_CORE_ISP2VHD_BYRP0) | (1 << SWRESET_CORE_ISP2VHD_BYRP1) |            \
		(1 << SWRESET_CORE_ISP2VHD_BYRP2) | (1 << SWRESET_CORE_ISP2VHD_BYRP3) |            \
		(1 << SWRESET_CORE_FRM_ID_DEC) | (1 << SWRESET_CORE_NFI_DEC0) |                    \
		(1 << SWRESET_CORE_NFI_DEC1) | (1 << SWRESET_CORE_NFI_DEC2) |                      \
		(1 << SWRESET_CORE_NFI_DEC3) | (1 << SWRESET_CORE_NFI_DEC4) |                      \
		(1 << SWRESET_CORE_NFI_DEC5) | (1 << SWRESET_CORE_NFI_DEC6) |                      \
		(1 << SWRESET_CORE_ISP2VHD_DMA0) | (1 << SWRESET_CORE_ISP2VHD_DMA1) |              \
		(1 << SWRESET_CORE_ISP2VHD_DMA2) | (1 << SWRESET_CORE_ISP2VHD_DMA3) |              \
		(1 << SWRESET_CORE_ISP2VHD_DMA4))

enum nfi_interrupt_map {
	INTR_NFI_1ST_FRAME_END = 0,
	INTR_NFI_LINK_TRIG = 1,
	/* 2: not used */
	INTR_NFI_2ND_FRAME_STR = 3,
	INTR_NFI_1ST_FRAME_STR = 4,
	/* 5: not used */
	INTR_NFI_2ND_FRAME_END = 6,
	INTR_NFI_MAX = 7,
};

enum ibuf_bitmode_id {
	IBUF_BITMODE_8BIT = 0,
	IBUF_BITMODE_10BIT = 1,
	IBUF_BITMODE_12BIT = 2,
	IBUF_BITMODE_14BIT = 3,
	IBUF_BITMODE_MAX,
};

#define CSIS_NFI_INTR_EN_MASK                                                                      \
	((0UL) | (1UL << INTR_NFI_1ST_FRAME_END) | (1UL << INTR_NFI_LINK_TRIG) |                   \
		(1UL << INTR_NFI_2ND_FRAME_STR) | (1UL << INTR_NFI_1ST_FRAME_STR) |                \
		(1UL << INTR_NFI_2ND_FRAME_END))

const char *nfi_int_str[INTR_NFI_MAX] = {
	[INTR_NFI_1ST_FRAME_END... INTR_NFI_MAX - 1] = "UNKNOWN",
	[INTR_NFI_1ST_FRAME_END] = "1ST_FRAME_END",
	[INTR_NFI_LINK_TRIG] = "LINK_TRIG",
	[INTR_NFI_2ND_FRAME_STR] = "2ND_FRAME_STR",
	[INTR_NFI_1ST_FRAME_STR] = "1ST_FRAME_STR",
	[INTR_NFI_2ND_FRAME_END] = "2ND_FRAME_END",
};
...
enum is_csis_pdp_top_reg_id {
	...
	CSIS_PDP_TOP_R_DBG_FRAME_CNT_CSIS0,
	CSIS_PDP_TOP_R_DBG_FRAME_CNT_CSIS1,
	CSIS_PDP_TOP_R_DBG_FRAME_CNT_CSIS2,
	CSIS_PDP_TOP_R_DBG_FRAME_CNT_CSIS3,
	CSIS_PDP_TOP_R_DBG_FRAME_CNT_CSIS4,
	CSIS_PDP_TOP_R_DBG_FRAME_CNT_CSIS5,
	CSIS_PDP_TOP_R_DBG_OVF_STATUS_BY_STALL,
	...
	CSIS_PDP_TOP_R_CSIS0_NFI_FID,
	CSIS_PDP_TOP_R_CSIS1_NFI_FID,
	CSIS_PDP_TOP_R_CSIS2_NFI_FID,
	CSIS_PDP_TOP_R_CSIS3_NFI_FID,
	CSIS_PDP_TOP_R_CSIS4_NFI_FID,
	CSIS_PDP_TOP_R_CSIS5_NFI_FID,
	CSIS_PDP_TOP_R_CSIS0_NFI_ID,
	CSIS_PDP_TOP_R_CSIS1_NFI_ID,
	CSIS_PDP_TOP_R_CSIS2_NFI_ID,
	CSIS_PDP_TOP_R_CSIS3_NFI_ID,
	CSIS_PDP_TOP_R_CSIS4_NFI_ID,
	CSIS_PDP_TOP_R_CSIS5_NFI_ID,
	...
	CSIS_PDP_TOP_R_CSIS_TOP_INTR_CLR,
	CSIS_PDP_TOP_R_NFI_INTR0_CLR,
	CSIS_PDP_TOP_R_NFI_INTR1_CLR,
...
static const struct is_reg is_csis_pdp_top_regs[CSIS_PDP_TOP_REG_CNT] = {
	...
	{ 0x0430, "CSIS4_NFI_EN" },
	{ 0x0434, "CSIS5_NFI_EN" },
	{ 0x043c, "CSIS0_NFI_FID" },
	{ 0x0440, "CSIS1_NFI_FID" },
	{ 0x0444, "CSIS2_NFI_FID" },
	{ 0x0448, "CSIS3_NFI_FID" },
	{ 0x044c, "CSIS4_NFI_FID" },
	{ 0x0450, "CSIS5_NFI_FID" },
	{ 0x0458, "CSIS0_NFI_ID" },
	{ 0x045c, "CSIS1_NFI_ID" },
	{ 0x0460, "CSIS2_NFI_ID" },
	{ 0x0464, "CSIS3_NFI_ID" },
	...
	{ 0x0828, "CSIS_TOP_INTR_CLR" },
	{ 0x082c, "NFI_INTR0_CLR" },
	{ 0x0830, "NFI_INTR1_CLR" },
...
enum is_csis_pdp_top_field_id {
	...
	CSIS_PDP_TOP_F_IBUF_ERR_MODULE_SWRESET_AUTO_EN,
	...
	CSIS_PDP_TOP_F_GLUEMUX_DMA_MUX_SEL0,
	CSIS_PDP_TOP_F_GLUEMUX_DMA_MUX_SEL1,
	CSIS_PDP_TOP_F_GLUEMUX_DMA_MUX_SEL2,
	CSIS_PDP_TOP_F_GLUEMUX_DMA_MUX_SEL3,
	CSIS_PDP_TOP_F_GLUEMUX_DMA_MUX_SEL4,
	CSIS_PDP_TOP_F_STALL_COUNTER_OTF_OUTPUT_PDP0,
	CSIS_PDP_TOP_F_STALL_COUNTER_OTF_OUTPUT_PDP1,
	CSIS_PDP_TOP_F_STALL_COUNTER_OTF_OUTPUT_PDP2,
	CSIS_PDP_TOP_F_STALL_COUNTER_OTF_OUTPUT_PDP3,
	CSIS_PDP_TOP_F_STALL_COUNTER_OTF_OUTPUT_BYRP0,
	CSIS_PDP_TOP_F_STALL_COUNTER_OTF_OUTPUT_BYRP1,
	CSIS_PDP_TOP_F_STALL_COUNTER_OTF_OUTPUT_BYRP2,
	CSIS_PDP_TOP_F_STALL_COUNTER_OTF_OUTPUT_BYRP3,
	CSIS_PDP_TOP_F_FRAME_CNT_FOR_CSIS0,
	CSIS_PDP_TOP_F_FRAME_CNT_FOR_CSIS1,
	CSIS_PDP_TOP_F_FRAME_CNT_FOR_CSIS2,
	CSIS_PDP_TOP_F_FRAME_CNT_FOR_CSIS3,
	CSIS_PDP_TOP_F_FRAME_CNT_FOR_CSIS4,
	CSIS_PDP_TOP_F_FRAME_CNT_FOR_CSIS5,
	CSIS_PDP_TOP_F_OTF0_OVF_BY_BYRP_STALL,
	CSIS_PDP_TOP_F_OTF1_OVF_BY_BYRP_STALL,
	CSIS_PDP_TOP_F_OTF2_OVF_BY_BYRP_STALL,
	CSIS_PDP_TOP_F_OTF3_OVF_BY_BYRP_STALL,
	CSIS_PDP_TOP_F_OTF0_OVF_BY_WDMA_STALL,
	CSIS_PDP_TOP_F_OTF1_OVF_BY_WDMA_STALL,
	CSIS_PDP_TOP_F_OTF2_OVF_BY_WDMA_STALL,
	CSIS_PDP_TOP_F_OTF3_OVF_BY_WDMA_STALL,
	...
	CSIS_PDP_TOP_F_CSISX_NFI_FRAME_ID_INFO,
	CSIS_PDP_TOP_F_CSISX_NFI_ID_INFO,
	...
	CSIS_PDP_TOP_F_SW_TRIGGER_EXTEND,
	...
	CSIS_PDP_TOP_F_NFI_INT_SRC_4_TO_5,
	CSIS_PDP_TOP_F_NFI_INT_EN_4_TO_5,
	...
	CSIS_PDP_TOP_F_NFI_ONE_FRAME_DELAY_ON,
	CSIS_PDP_TOP_F_TOP_INTR_CLR,
	CSIS_PDP_TOP_F_NFI_INTR_CLR_0_TO_3,
	CSIS_PDP_TOP_F_NFI_INTR_CLR_4_TO_5,
	...
	CSIS_PDP_TOP_F_IN_TOKEN_4_7,
	CSIS_PDP_TOP_F_IN_TOKEN_8_11,
	CSIS_PDP_TOP_F_OUT_TOKEN_0_3,
	CSIS_PDP_TOP_F_OUT_TOKEN_4_7,
	CSIS_PDP_TOP_F_OUT_TOKEN_8_11,
...
static const struct is_field is_csis_pdp_top_fields[CSIS_PDP_TOP_FIELD_CNT] = {
	...
	{ "FRAME_CNT_FOR_CSISX", 0, 32, RO, 0x00000000 },
	{ "OTF0_OVF_BY_BYRP_STALL", 0, 1, RO, 0x0 },
	{ "OTF1_OVF_BY_BYRP_STALL", 1, 1, RO, 0x0 },
	{ "OTF2_OVF_BY_BYRP_STALL", 2, 1, RO, 0x0 },
	{ "OTF3_OVF_BY_BYRP_STALL", 3, 1, RO, 0x0 },
	{ "OTF0_OVF_BY_WDMA_STALL", 4, 1, RO, 0x0 },
	{ "OTF1_OVF_BY_WDMA_STALL", 5, 1, RO, 0x0 },
	{ "OTF2_OVF_BY_WDMA_STALL", 6, 1, RO, 0x0 },
	{ "OTF3_OVF_BY_WDMA_STALL", 7, 1, RO, 0x0 },
	{ "IBUF0", 0, 6, RW, 0x3F },
	{ "IBUF1", 8, 6, RW, 0x3F },
	{ "IBUF2", 16, 6, RW, 0x3F },
	{ "IBUF3", 24, 6, RW, 0x3F },
	...
	{ "CSISX_NFI_FRAME_ID_INFO", 0, 8, RO, 0x00 },
	{ "CSISX_NFI_ID_INFO", 0, 8, RO, 0x00 },
	{ "INTR_SOURCE", 0, 32, RO, 0x00000000 },
	{ "INTR_ENABLE", 0, 32, RW, 0x00000000 },
	{ "TOP_STATUS", 0, 32, RO, 0x00000000 },
	{ "NFI_INT_SRC_0_TO_3", 0, 32, RO, 0x00000000 },
	{ "NFI_INT_EN_0_TO_3", 0, 32, RW, 0x00000000 },
	{ "NFI_CSIS_LINK_SET_INFO", 0, 6, RO, 0x00 },
	{ "NFI_OTF_SET0", 0, 1, RO, 0x0 },
	{ "NFI_OTF_SET1", 8, 1, RO, 0x0 },
	{ "NFI_OTF_SET2", 16, 1, RO, 0x0 },
	{ "NFI_OTF_SET3", 24, 1, RO, 0x0 },
	{ "SW_TRIGGER", 0, 6, RW, 0x00 },
	{ "SW_TRIGGER_EXTEND", 8, 6, RW, 0x00 },
	{ "NFI_OTF_SET0_CLR", 0, 1, RW, 0x0 },
	{ "NFI_OTF_SET1_CLR", 8, 1, RW, 0x0 },
	{ "NFI_OTF_SET2_CLR", 16, 1, RW, 0x0 },
	{ "NFI_OTF_SET3_CLR", 24, 1, RW, 0x0 },
	{ "NFI_CSIS_LINK_SET_CLR", 0, 6, RW, 0x00 },
	{ "NFI_INT_SRC_4_TO_5", 0, 10, RO, 0x000 },
	{ "NFI_INT_EN_4_TO_5", 0, 10, RW, 0x000 },
	...
	{ "NFI_ONE_FRAME_DELAY_ON", 6, 1, RW, 0x0 },
	{ "TOP_INTR_CLR", 0, 32, RW, 0x00000000 },
	{ "NFI_INTR_CLR_0_TO_3", 0, 32, RW, 0x00000000 },
	{ "NFI_INTR_CLR_4_TO_5", 0, 10, RW, 0x000 },
...
enum is_csis_ibuf_reg_id {
	...
	CSIS_IBUF_R_IBUFX_ERR_STATUS_0,
	CSIS_IBUF_R_IBUFX_ERR_STATUS_1,
...
static const struct is_reg is_csis_ibuf_regs[CSIS_IBUF_REG_CNT] = {
	...
	{ 0x2028, "IBUFX_ERR_STATUS_0" },
	{ 0x202c, "IBUFX_ERR_STATUS_1" },
...
enum is_csis_ibuf_field_id {
	...
	CSIS_IBUF_F_ERR_CALC_WC,
	CSIS_IBUF_F_ERR_IN_WC,
	CSIS_IBUF_F_ERR_WC_ERR,
	CSIS_IBUF_F_ERR_HSIZE_ERR_SHORT,
	CSIS_IBUF_F_ERR_HSIZE_ERR_LONG,
	CSIS_IBUF_F_ERR_VSIZE_ERR_SHORT,
	CSIS_IBUF_F_ERR_VSIZE_ERR_LONG,
...
static const struct is_field is_csis_ibuf_fields[CSIS_IBUF_FIELD_CNT] = {
	...
	{ "ERR_CALC_WC", 0, 16, RO, 0x0000 },
	{ "ERR_IN_WC", 16, 16, RO, 0x0000 },
	{ "ERR_WC_ERR", 0, 1, RO, 0x0 },
	{ "ERR_HSIZE_ERR_SHORT", 4, 1, RO, 0x0 },
	{ "ERR_HSIZE_ERR_LONG", 8, 1, RO, 0x0 },
	{ "ERR_VSIZE_ERR_SHORT", 16, 6, RO, 0x00 },
	{ "ERR_VSIZE_ERR_LONG", 24, 6, RO, 0x00 },
...
enum is_csis_bns_field_id {
	...
	CSIS_BNS_F_WEIGHT_Y_0_0,
	CSIS_BNS_F_WEIGHT_Y_0_1,
	CSIS_BNS_F_WEIGHT_Y_0_2,
	CSIS_BNS_F_WEIGHT_Y_0_3,
	CSIS_BNS_F_WEIGHT_Y_0_4,
	CSIS_BNS_F_CRC_SEED,
...
static const struct is_field is_csis_bns_fields[CSIS_BNS_FIELD_CNT] = {
	...
	{ "WEIGHT_Y_0_0", 0, 8, RW, 0x00 },
	{ "WEIGHT_Y_0_1", 8, 8, RW, 0x00 },
	{ "WEIGHT_Y_0_2", 16, 8, RW, 0x00 },
	{ "WEIGHT_Y_0_3", 24, 8, RW, 0x00 },
	{ "WEIGHT_Y_0_4", 0, 8, RW, 0x00 },
	{ "CRC_SEED", 0, 8, RW, 0x00 },
	{ "CRC_RESULT", 8, 8, RO, 0x00 },
};
#endif /* IS_SFR_CSIS_PDP_TOP_V14_0_H */

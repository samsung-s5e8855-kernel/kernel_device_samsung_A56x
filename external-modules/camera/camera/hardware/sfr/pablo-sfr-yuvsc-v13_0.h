...
static const struct pmio_range yuvsc_non_rd_ranges[] = {
	...
	pmio_reg_range(0x1800, 0x3fff),
	pmio_reg_range(0x4100, 0x43ff),
	pmio_reg_range(0x4500, 0x4bff),
	pmio_reg_range(0x4e00, 0x51ff),
	pmio_reg_range(0x5400, 0x59ff),
	pmio_reg_range(0x5c00, 0x60ff),
};

static const struct pmio_access_table yuvsc_rd_ranges_table = {
	.no_ranges = yuvsc_non_rd_ranges,
	.n_no_ranges = ARRAY_SIZE(yuvsc_non_rd_ranges),
};

static const struct pmio_range yuvsc_volatile_ranges[] = {
	pmio_reg_range(YUVSC_R_SW_RESET, YUVSC_R_SW_APB_RESET),
	...
	pmio_reg_range(YUVSC_R_STAT_RDMACL_EN, YUVSC_R_STAT_RDMACL_EN),
	pmio_reg_range(YUVSC_R_STAT_RDMACL_IMG_CRC_1P, YUVSC_R_STAT_RDMACL_MON_STATUS3),
	pmio_reg_range(YUVSC_R_LIC_LITE_DEBUG_FIFO_STATUS,
		       YUVSC_R_LIC_LITE_DEBUG_STALL_THR_DATA_FIFO),

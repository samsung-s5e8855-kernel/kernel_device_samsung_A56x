...
#ifndef IS_HW_YUVP_V3_H
#define IS_HW_YUVP_V3_H
...
enum is_hw_yuvp_event_id { YUVP_EVENT_FRAME_START = 1, YUVP_EVENT_FRAME_END };
...
struct is_hw_yuvp {
	...
	struct is_yuvp_config config[IS_STREAM_COUNT];

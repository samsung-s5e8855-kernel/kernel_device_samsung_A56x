...
#include "sfr/is-sfr-yuvp-v13_20.h"
#include "pmio.h"
...
void yuvp_hw_init_pmio_config(struct pmio_config *cfg)
{
	...
	cfg->max_register = YUVP_R_YUV_YUV422TO444_STREAM_CRC;
	cfg->num_reg_defaults_raw = (YUVP_R_YUV_YUV422TO444_STREAM_CRC >> 2) + 1;

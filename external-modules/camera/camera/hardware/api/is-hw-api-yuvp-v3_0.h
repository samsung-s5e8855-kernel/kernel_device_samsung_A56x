...
#define YUVP_SET_F(base, R, F, val) is_hw_set_field(base, &yuvp_regs[R], &yuvp_fields[F], val)
#define YUVP_SET_F_DIRECT(base, R, F, val)                                                         \
	is_hw_set_field(base, &yuvp_regs[R], &yuvp_fields[F], val)
#define YUVP_SET_R(base, R, val) is_hw_set_reg(base, &yuvp_regs[R], val)
#define YUVP_SET_R_DIRECT(base, R, val) is_hw_set_reg(base, &yuvp_regs[R], val)
#define YUVP_SET_V(base, reg_val, F, val) is_hw_set_field_value(reg_val, &yuvp_fields[F], val)

#define YUVP_GET_F(base, R, F) is_hw_get_field(base, &yuvp_regs[R], &yuvp_fields[F])
#define YUVP_GET_R(base, R) is_hw_get_reg(base, &yuvp_regs[R])
#define YUVP_GET_R_COREX(base, R) is_hw_get_reg(base, &yuvp_regs[R])
#define YUVP_GET_V(reg_val, F) is_hw_get_field_value(reg_val, &yuvp_fields[F])
#else

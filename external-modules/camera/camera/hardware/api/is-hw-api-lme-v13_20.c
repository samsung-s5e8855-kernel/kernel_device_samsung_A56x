...
#include "sfr/is-sfr-lme-mmio-v13_20.h"
#else
#include "sfr/is-sfr-lme-v13_20.h"
#endif
...
static void lme_hw_s_block_crc(void __iomem *base, u32 set_id)
{
	...
	LME_SET_F(base, GET_COREX_OFFSET(COREX_DIRECT) +
		LME_R_AXICRC_SIPULME_CNTX0_SEED_0,
			LME_F_AXICRC_SIPULME_CNTX0_SEED_0, 0x37);
	LME_SET_F(base, GET_COREX_OFFSET(COREX_DIRECT) +
		LME_R_AXICRC_SIPULME_CNTX0_SEED_0,
			LME_F_AXICRC_SIPULME_CNTX0_SEED_1, 0x37);
}
...
{
	LME_SET_F(base, LME_R_AXICRC_SIPULME_CNTX0_SEED_0,
			LME_F_AXICRC_SIPULME_CNTX0_SEED_0, seed);
	LME_SET_F(base, LME_R_AXICRC_SIPULME_CNTX0_SEED_1,
			LME_F_AXICRC_SIPULME_CNTX0_SEED_1, seed);
}

...
#ifndef IS_HW_API_MTNR1_V13_0_H
#define IS_HW_API_MTNR1_V13_0_H
...
enum mtnr1_dtp_type {
	MTNR1_DTP_BYPASS,
	MTNR1_DTP_SOLID_IMAGE,
	MTNR1_DTP_COLOR_BAR,
};

enum mtnr1_dtp_color_bar {
	MTNR1_DTP_COLOR_BAR_BT601,
	MTNR1_DTP_COLOR_BAR_BT709,
};

struct mtnr1_radial_cfg {
...
int mtnr1_hw_rdma_create(struct is_common_dma *dma, void *base, u32 input_id);
int mtnr1_hw_wdma_create(struct is_common_dma *dma, void *base, u32 input_id);
...
void mtnr1_hw_pmio_write_test(struct pablo_mmio *base, u32 set_id);
void mtnr1_hw_pmio_read_test(struct pablo_mmio *base, u32 set_id);

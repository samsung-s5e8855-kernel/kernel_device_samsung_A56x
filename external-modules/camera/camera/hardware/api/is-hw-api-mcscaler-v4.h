...
#define DJAG_PRE_LINE_BUF_SIZE	4880
...
#define MCSC_SET_R_DIRECT(base, R, val) \
	is_hw_set_reg(base, &mcsc_regs[R], val)
#define MCSC_SET_V(base, reg_val, F, val) \
...
void is_scaler_set_predjag_tuning_param(struct pablo_mmio *base_addr,
	const struct predjag_scaling_ratio_depended_config *djag_tune);
...
void is_scaler_set_predjag_dither_wb(
	struct pablo_mmio *base_addr, struct djag_wb_thres_cfg *djag_wb, u32 wht, u32 blk);
...
int is_scaler_set_hf_config(struct is_common_dma *dma, struct pablo_mmio *base_addr, u32 hw_id,
	bool hf_enable, struct param_mcs_output *param, struct mcsc_radial_cfg *radial_cfg,

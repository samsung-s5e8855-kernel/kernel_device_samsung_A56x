...
static void _csi_hw_s_dma_input_mux(void __iomem *mux_regs, u32 wdma_index, int otf_ch, bool mux_en,
...
{
	_csi_hw_s_dma_input_mux(mux_regs, wdma_index, otf_ch, true, bns_en, bns_dma_mux_val);
}

void csi_hw_s_init_input_mux(void __iomem *mux_regs, u32 idx_wdma, u32 index)
{
	_csi_hw_s_dma_input_mux(mux_regs, index, 0, false, false, 0);
}

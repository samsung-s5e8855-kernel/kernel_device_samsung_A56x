...
static int aw_pid_2308_dev_init(struct aw882xx *aw882xx)
{
	...
	aw_pa->mute_desc.pwd_check = AW_PID_2308_PWD_CHECK;
	aw_pa->mute_desc.amppd_check = AW_PID_2308_AMPPD_CHECK;
	aw_pa->mute_desc.hmute_check = AW_PID_2308_HMUTE_CHECK;
	...
	aw_pa->i2sen_desc.i2srxen_check = AW_PID_2308_I2RXSEN_CHECK;

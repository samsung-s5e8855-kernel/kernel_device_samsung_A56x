...
#define S6E3FC5_LOCAL_HBM_COMP_REG			0xD8
#define S6E3FC5_LOCAL_HBM_COMP_OFS			24
#define S6E3FC5_LOCAL_HBM_COMP_LEN			10
...
#endif
static u8 S6E3FC5_LOCAL_HBM_COMP[S6E3FC5_LOCAL_HBM_COMP_LEN];
...
#endif
	[READ_LOCAL_HBM_COMP] = RDINFO_INIT(local_hbm_comp, DSI_PKT_TYPE_RD, S6E3FC5_LOCAL_HBM_COMP_REG, S6E3FC5_LOCAL_HBM_COMP_OFS, S6E3FC5_LOCAL_HBM_COMP_LEN),
};
...
#endif
static DEFINE_RESUI(local_hbm_comp, &s6e3fc5_rditbl[READ_LOCAL_HBM_COMP], 0);
...
#endif
	[RES_LOCAL_HBM_COMP] = RESINFO_INIT(local_hbm_comp, S6E3FC5_LOCAL_HBM_COMP, RESUI(local_hbm_comp)),
};
